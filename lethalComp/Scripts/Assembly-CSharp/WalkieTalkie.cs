...
public class WalkieTalkie : GrabbableObject
{
	...
	public void PlayWallAudioRpc()
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				...
				FastBufferWriter bufferWriter = __beginSendRpc(2120861548u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				__endSendRpc(ref bufferWriter, 2120861548u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	{
		__registerRpc(64994802u, __rpc_handler_64994802, "SetPlayerSpeakingOnWalkieTalkieServerRpc");
		__registerRpc(2961867446u, __rpc_handler_2961867446, "SetPlayerSpeakingOnWalkieTalkieClientRpc");
		__registerRpc(2502573704u, __rpc_handler_2502573704, "UnsetPlayerSpeakingOnWalkieTalkieServerRpc");
		__registerRpc(3968582452u, __rpc_handler_3968582452, "UnsetPlayerSpeakingOnWalkieTalkieClientRpc");
		__registerRpc(2120861548u, __rpc_handler_2120861548, "PlayWallAudioRpc");
	...
	private static void __rpc_handler_2120861548(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((WalkieTalkie)target).PlayWallAudioRpc();
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}
