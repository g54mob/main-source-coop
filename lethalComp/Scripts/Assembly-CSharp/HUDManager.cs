...
public class HUDManager : NetworkBehaviour
{
	...
	public void CreateFurnitureAdModelAndDisplayAdClientRpc(int indexInShipDecorList)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute && (networkManager.IsServer || networkManager.IsHost))
		{
			...
			FastBufferWriter bufferWriter = __beginSendClientRpc(1647277829u, clientRpcParams, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, indexInShipDecorList);
			__endSendClientRpc(ref bufferWriter, 1647277829u, clientRpcParams, RpcDelivery.Reliable);
		}
	...
	public void CreateToolAdModelAndDisplayAdClientRpc(int steepestSale, int itemIndex)
	{
		...
		{
			ClientRpcParams clientRpcParams = default(ClientRpcParams);
			FastBufferWriter bufferWriter = __beginSendClientRpc(229674455u, clientRpcParams, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, steepestSale);
			BytePacker.WriteValueBitPacked(bufferWriter, itemIndex);
			__endSendClientRpc(ref bufferWriter, 229674455u, clientRpcParams, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Execute || (!networkManager.IsClient && !networkManager.IsHost))
		{
			return;
	...
	{
		__registerRpc(1647277829u, __rpc_handler_1647277829, "CreateFurnitureAdModelAndDisplayAdClientRpc");
		__registerRpc(229674455u, __rpc_handler_229674455, "CreateToolAdModelAndDisplayAdClientRpc");
		__registerRpc(2930587515u, __rpc_handler_2930587515, "AddPlayerChatMessageServerRpc");
		__registerRpc(168728662u, __rpc_handler_168728662, "AddPlayerChatMessageClientRpc");
		__registerRpc(2787681914u, __rpc_handler_2787681914, "AddTextMessageServerRpc");
		__registerRpc(1568596901u, __rpc_handler_1568596901, "AddTextMessageClientRpc");
		__registerRpc(1944155956u, __rpc_handler_1944155956, "ScanNewCreatureServerRpc");
		__registerRpc(3039261141u, __rpc_handler_3039261141, "ScanNewCreatureClientRpc");
		__registerRpc(3153465849u, __rpc_handler_3153465849, "GetNewStoryLogServerRpc");
		__registerRpc(2416035003u, __rpc_handler_2416035003, "GetNewStoryLogClientRpc");
		__registerRpc(2436660286u, __rpc_handler_2436660286, "UseSignalTranslatorServerRpc");
		__registerRpc(1255866175u, __rpc_handler_1255866175, "UseSignalTranslatorClientRpc");
		__registerRpc(2352591293u, __rpc_handler_2352591293, "SyncAllPlayerLevelsServerRpc");
		__registerRpc(1570713893u, __rpc_handler_1570713893, "SyncAllPlayerLevelsClientRpc");
		__registerRpc(1389701054u, __rpc_handler_1389701054, "SyncPlayerLevelServerRpc");
		__registerRpc(4217433937u, __rpc_handler_4217433937, "SyncAllPlayerLevelsServerRpc");
		__registerRpc(2220027482u, __rpc_handler_2220027482, "SyncAllPlayerLevelsClientRpc");
		__registerRpc(1676259161u, __rpc_handler_1676259161, "SyncPlayerLevelClientRpc");
		__registerRpc(1616150480u, __rpc_handler_1616150480, "AlarmHornServerRpc");
		__registerRpc(840104050u, __rpc_handler_840104050, "AlarmHornClientRpc");
		__registerRpc(551948140u, __rpc_handler_551948140, "UpdateInstabilityClientRpc");
		__registerRpc(1043384750u, __rpc_handler_1043384750, "SendErrorMessageServerRpc");
	...
	private static void __rpc_handler_1647277829(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			((HUDManager)target).CreateFurnitureAdModelAndDisplayAdClientRpc(value);
	...
	private static void __rpc_handler_229674455(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((HUDManager)target).CreateToolAdModelAndDisplayAdClientRpc(value, value2);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}
