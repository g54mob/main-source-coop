...
public class StunGrenadeItem : GrabbableObject
{
	...
	{
		__registerRpc(2106007416u, __rpc_handler_2106007416, "SetExplodeOnThrowServerRpc");
		__registerRpc(1175066890u, __rpc_handler_1175066890, "SetExplodeOnThrowClientRpc");
