...
namespace Coffee.UIEffects
{
	...
	public abstract class UIEffectBase : UIBehaviour, IMeshModifier, IMaterialModifier, ICanvasRaycastFilter, ITimeControl
	{
		...
		{
			if (!(_material == null) && !(graphic == null) && !(canvas == null) && context != null)
			{
				if (_isContextDirty)
				{
		...
		public virtual Material GetModifiedMaterial(Material baseMaterial)
		{
			...
			uint u32_2 = ((transitionRoot != null) ? ((uint)transitionRoot.GetHashCode()) : 0u);
			Hash128 hash = new Hash128((uint)baseMaterial.GetHashCode(), effectId, u32_, u32_2);
		...
		{
			if (base.isActiveAndEnabled && context != null && !(material == null))
			{
				_isContextDirty = false;
