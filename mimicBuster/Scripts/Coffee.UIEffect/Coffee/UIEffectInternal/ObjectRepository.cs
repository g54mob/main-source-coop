...
namespace Coffee.UIEffectInternal
{
	internal class ObjectRepository<T> where T : UnityEngine.Object
	{
		...
		public void Release(ref T obj)
		{
			...
			if (_objectKey.TryGetValue(hashCode, out var value) && _cache.TryGetValue(value, out var value2))
			{
				value2.reference--;
				if (value2.reference <= 0 || value2.storedObject == null)
				{
					Remove(value2);
				}
			}
