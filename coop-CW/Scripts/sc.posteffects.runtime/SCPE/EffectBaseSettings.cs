...
namespace SCPE
{
	...
	public class EffectBaseSettings
	{
		...
		public EffectBaseSettings(bool enableInSceneView = true)
		{
			...
			{
				cameraTypes = CameraTypeFlags.GameBase | CameraTypeFlags.GameOverlay;
			}
			else
			{
				cameraTypes = CameraTypeFlags.GameBase | CameraTypeFlags.SceneView;
			}
		}

		public RenderPassEvent GetInjectionPoint()
		{
			if (executionOrder != ExecutionOrder.BeforePostProcessing)
			{
