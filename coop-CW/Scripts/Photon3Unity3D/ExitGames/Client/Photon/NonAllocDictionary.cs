...
namespace ExitGames.Client.Photon
{
	...
	{
		public struct KeyIterator : IEnumerator<K>, IDisposable, IEnumerator
		{
			private int _index;
		...
		public struct ValueIterator : IEnumerator<V>, IDisposable, IEnumerator
		{
			private int _index;
		...
		public struct PairIterator : IEnumerator<KeyValuePair<K, V>>, IDisposable, IEnumerator
		{
			private int _index;
