...
namespace ExitGames.Client.Photon
{
	public class PhotonPeer
	{
		...
		public TargetFrameworks TargetFramework = TargetFrameworks.Net35;
		...
		public int SequenceDeltaLimitResends = 100;

		public int SequenceDeltaLimitSends = 75;
		...
		public Type PayloadEncryptorType
		{
			...
			{
				bool flag = false;
				if ((object)value == null || typeof(ICryptoProvider).IsAssignableFrom(value))
				{
		...
		public Type EncryptorType
		{
			...
			{
				bool flag = false;
				if ((object)value == null || typeof(IPhotonEncryptor).IsAssignableFrom(value))
				{
					encryptorType = value;
				}
				else
