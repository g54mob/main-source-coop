...
namespace RootMotion.FinalIK
{
	...
	public class GrounderQuadruped : Grounder
	{
		...
		private void OnSolverUpdate()
		{
			...
			Vector3 toDirection = lastSpineBone.position + forelegSolver.root.up * Mathf.Clamp(forelegSolver.pelvis.heightOffset, -1f / 0f, 0f) - solver.root.up * solver.pelvis.heightOffset - pelvis.position;
