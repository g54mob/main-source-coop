...
namespace Rewired
{
	...
	internal class HardwareJoystickMap_InputManager
	{
		...
		private readonly DeviceLocalizationInfo XUlAxCstwUNNUibsumpSthwecoDL;

		public DeviceLocalizationInfo deviceLocalizationInfo => XUlAxCstwUNNUibsumpSthwecoDL;
		...
		public HardwareJoystickMap_InputManager(HardwareControllerMapIdentifier P_0, JoystickType[] P_1, DeviceLocalizationInfo P_2, HardwareJoystickMap.Platform P_3, string P_4, int P_5, int P_6, int P_7, HardwareJoystickMap.CompoundElement[] P_8)
		{
			...
			map = P_3;
			controllerName = P_4;
			XUlAxCstwUNNUibsumpSthwecoDL = ((P_2 != null) ? P_2 : new DeviceLocalizationInfo(ControllerType.Joystick, false, P_0.guid, null, null));
			buttonCount = P_5;
			axisCount = P_6;
		...
		public HardwareControllerMap_Game ToGameHardwareControllerMap()
		{
			...
			return new HardwareControllerMap_Game(controllerName, XUlAxCstwUNNUibsumpSthwecoDL, hardwareMapIdentifier, array, elementIdentifiers, buttons, axes, axisCalibrationData, axisRanges, axisInfos, buttonInfos, compoundElements);
		}
	}
}
