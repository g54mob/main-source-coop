...
namespace Rewired.Data
{
	...
	public abstract class UserDataStore : MonoBehaviour, IUserDataStore, IControllerMapStore
	{
		...
		void IControllerMapStore.SaveControllerMap(int playerId, ControllerMap controllerMap)
		{
			//ILSpy generated this explicit interface implementation from .override directive in SaveControllerMap
			this.SaveControllerMap(playerId, controllerMap);
		}
		...
		ControllerMap IControllerMapStore.LoadControllerMap(int playerId, ControllerIdentifier controllerIdentifier, int categoryId, int layoutId)
		{
			//ILSpy generated this explicit interface implementation from .override directive in LoadControllerMap
			return this.LoadControllerMap(playerId, controllerIdentifier, categoryId, layoutId);
		}
