...
namespace Mirror
{
	...
	public static class GeneratedNetworkCode
	{
		...
		public static void _Write_EvilCore_002EParticles_002ENetworkParticleOverrides(NetworkWriter writer, NetworkParticleOverrides value)
		{
			writer.WriteFloat(value.ScaleMultiplier);
			writer.WriteColor(value.StartColor);
			writer.WriteFloat(value.SimulationSpeed);
		}

		public static NetworkParticleOverrides _Read_EvilCore_002EParticles_002ENetworkParticleOverrides(NetworkReader reader)
		{
			return new NetworkParticleOverrides
			{
				ScaleMultiplier = reader.ReadFloat(),
				StartColor = reader.ReadColor(),
				SimulationSpeed = reader.ReadFloat()
			};
		}
		...
		public static void InitReadWriters()
		{
			...
			Writer<NetworkParticleOverrides>.write = _Write_EvilCore_002EParticles_002ENetworkParticleOverrides;
			...
			Reader<NetworkParticleOverrides>.read = _Read_EvilCore_002EParticles_002ENetworkParticleOverrides;
		}
	}
}
