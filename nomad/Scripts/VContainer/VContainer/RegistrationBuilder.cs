...
namespace VContainer
{
	public class RegistrationBuilder
	{
		...
		{
			InstanceProvider provider = new InstanceProvider(InjectorCache.GetOrBuild(ImplementationType), Parameters);
		...
		{
			return WithParameter(typeof(TParam), (IObjectResolver resolver) => value(resolver));
		}

		public RegistrationBuilder WithParameter<TParam>(Func<TParam> value)
		{
			return WithParameter(typeof(TParam), (IObjectResolver _) => value());
		}
