...
namespace Coffee.UIEffects
{
	internal static class UIVertexUtil
	{
		...
		{
			Vector2 min = new Vector2(3.4028235E+38f, 3.4028235E+38f);
			Vector2 max = new Vector2(-3.4028235E+38f, -3.4028235E+38f);
			Vector2 min2 = new Vector2(3.4028235E+38f, 3.4028235E+38f);
			Vector2 max2 = new Vector2(-3.4028235E+38f, -3.4028235E+38f);
