...
namespace Mirror
{
	...
	public static class GeneratedNetworkCode
	{
		...
		public static void _Write_EvilCore_002ENetworking_002EParenting_002ENetworkedTransformParentingConfig(NetworkWriter writer, NetworkedTransformParentingConfig value)
		{
			writer.WriteVector3(value.PositionOffset);
			writer.WriteVector3(value.RotationOffset);
			writer.WriteBool(value.KeepPositionAxes);
			writer.WriteBool(value.KeepRotationAxes);
		}

		public static NetworkedTransformParentingConfig _Read_EvilCore_002ENetworking_002EParenting_002ENetworkedTransformParentingConfig(NetworkReader reader)
		{
			return new NetworkedTransformParentingConfig
			{
				PositionOffset = reader.ReadVector3(),
				RotationOffset = reader.ReadVector3(),
				KeepPositionAxes = reader.ReadBool(),
				KeepRotationAxes = reader.ReadBool()
			};
		}

		public static void _Write_EvilCore_002ENetworking_002EParenting_002ENetworkedParentTransformData(NetworkWriter writer, NetworkedParentTransformData value)
		{
			writer.WriteVarUInt(value.ParentNetworkedTransformNetId);
			NetworkWriterExtensions.WriteByte(writer, value.SubTransformIndex);
			_Write_EvilCore_002ENetworking_002EParenting_002ENetworkedTransformParentingConfig(writer, value.ParentingConfig);
		}

		public static NetworkedParentTransformData _Read_EvilCore_002ENetworking_002EParenting_002ENetworkedParentTransformData(NetworkReader reader)
		{
			return new NetworkedParentTransformData
			{
				ParentNetworkedTransformNetId = reader.ReadVarUInt(),
				SubTransformIndex = NetworkReaderExtensions.ReadByte(reader),
				ParentingConfig = _Read_EvilCore_002ENetworking_002EParenting_002ENetworkedTransformParentingConfig(reader)
			};
		}
		...
		public static void InitReadWriters()
		{
			...
			Writer<NetworkedTransform>.write = NetworkWriterExtensions.WriteNetworkBehaviour;
			Writer<NetworkedTransformParentingConfig>.write = _Write_EvilCore_002ENetworking_002EParenting_002ENetworkedTransformParentingConfig;
			Writer<NetworkedParentTransformData>.write = _Write_EvilCore_002ENetworking_002EParenting_002ENetworkedParentTransformData;
			...
			Reader<NetworkedTransform>.read = NetworkReaderExtensions.ReadNetworkBehaviour<NetworkedTransform>;
			Reader<NetworkedTransformParentingConfig>.read = _Read_EvilCore_002ENetworking_002EParenting_002ENetworkedTransformParentingConfig;
			Reader<NetworkedParentTransformData>.read = _Read_EvilCore_002ENetworking_002EParenting_002ENetworkedParentTransformData;
		}
	}
}
