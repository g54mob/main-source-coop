...
namespace Mirror.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecP160R2Field
	{
		...
		{
			if (Nat.Inc(5, x, z) != 0 || (z[4] == 4294967295u && Nat160.Gte(z, P)))
			{
				Nat.Add33To(5, 21389u, z);
			}
		}
		...
		public static uint[] FromBigInteger(BigInteger x)
		{
			...
			if (array[4] == 4294967295u && Nat160.Gte(array, P))
			{
		...
		{
			if ((Nat160.MulAddTo(x, y, zz) != 0 || (zz[9] == 4294967295u && Nat.Gte(10, zz, PExt))) && Nat.AddTo(PExtInv.Length, PExtInv, zz) != 0)
			{
		...
		public static void Reduce(uint[] xx, uint[] z)
		{
			...
			if (Nat160.Mul33DWordAdd(21389u, y, z, 0) != 0 || (z[4] == 4294967295u && Nat160.Gte(z, P)))
			{
				Nat.Add33To(5, 21389u, z);
			}
		}
		...
		{
			if ((x != 0 && Nat160.Mul33WordAdd(21389u, x, z, 0) != 0) || (z[4] == 4294967295u && Nat160.Gte(z, P)))
			{
				Nat.Add33To(5, 21389u, z);
			}
		}
