...
namespace Mirror.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecP224R1Field
	{
		...
		public static uint[] FromBigInteger(BigInteger x)
		{
			...
			if (array[6] == 4294967295u && Nat224.Gte(array, P))
			{
		...
		{
			if ((Nat224.MulAddTo(x, y, zz) != 0 || (zz[13] == 4294967295u && Nat.Gte(14, zz, PExt))) && Nat.AddTo(PExtInv.Length, PExtInv, zz) != 0)
			{
		...
		public static void Reduce(uint[] xx, uint[] z)
		{
			...
			z[3] = (uint)num10;
			num8 = num10 >> 32;
			if ((num8 != 0L && Nat.IncAt(7, z, 4) != 0) || (z[6] == 4294967295u && Nat224.Gte(z, P)))
			{
				AddPInvTo(z);
			}
		}
		...
		public static void Reduce32(uint x, uint[] z)
		{
			...
			if ((num != 0L && Nat.IncAt(7, z, 4) != 0) || (z[6] == 4294967295u && Nat224.Gte(z, P)))
			{
				AddPInvTo(z);
			}
		}
