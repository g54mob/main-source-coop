...
namespace Mirror.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecP384R1Field
	{
		...
		{
			if ((Nat.Add(24, xx, yy, zz) != 0 || (zz[23] == 4294967295u && Nat.Gte(24, zz, PExt))) && Nat.AddTo(PExtInv.Length, PExtInv, zz) != 0)
			{
		...
		{
			if (Nat.Inc(12, x, z) != 0 || (z[11] == 4294967295u && Nat.Gte(12, z, P)))
			{
				AddPInvTo(z);
			}
		}
		...
		public static uint[] FromBigInteger(BigInteger x)
		{
			...
			if (array[11] == 4294967295u && Nat.Gte(12, array, P))
			{
		...
		public static void Reduce32(uint x, uint[] z)
		{
			...
			if ((num != 0L && Nat.IncAt(12, z, 5) != 0) || (z[11] == 4294967295u && Nat.Gte(12, z, P)))
			{
				AddPInvTo(z);
			}
		}
		...
		{
			if (Nat.ShiftUpBit(12, x, 0u, z) != 0 || (z[11] == 4294967295u && Nat.Gte(12, z, P)))
			{
				AddPInvTo(z);
			}
		}
