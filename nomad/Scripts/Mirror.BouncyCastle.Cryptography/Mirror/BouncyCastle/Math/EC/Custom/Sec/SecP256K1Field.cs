...
namespace Mirror.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecP256K1Field
	{
		...
		{
			if (Nat.Inc(8, x, z) != 0 || (z[7] == 4294967295u && Nat256.Gte(z, P)))
			{
				Nat.Add33To(8, 977u, z);
			}
		}
		...
		public static uint[] FromBigInteger(BigInteger x)
		{
			...
			if (array[7] == 4294967295u && Nat256.Gte(array, P))
			{
		...
		{
			if ((Nat256.MulAddTo(x, y, zz) != 0 || (zz[15] == 4294967295u && Nat.Gte(16, zz, PExt))) && Nat.AddTo(PExtInv.Length, PExtInv, zz) != 0)
			{
		...
		public static void Reduce(uint[] xx, uint[] z)
		{
			...
			if (Nat256.Mul33DWordAdd(977u, y, z, 0) != 0 || (z[7] == 4294967295u && Nat256.Gte(z, P)))
			{
				Nat.Add33To(8, 977u, z);
			}
		}
		...
		{
			if ((x != 0 && Nat256.Mul33WordAdd(977u, x, z, 0) != 0) || (z[7] == 4294967295u && Nat256.Gte(z, P)))
			{
				Nat.Add33To(8, 977u, z);
			}
		}
		...
		{
			if (Nat.ShiftUpBit(8, x, 0u, z) != 0 || (z[7] == 4294967295u && Nat256.Gte(z, P)))
			{
				Nat.Add33To(8, 977u, z);
			}
		}
