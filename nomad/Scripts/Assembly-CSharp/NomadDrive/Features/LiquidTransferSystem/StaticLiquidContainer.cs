...
namespace NomadDrive.Features.LiquidTransferSystem
{
	...
	public class StaticLiquidContainer : Interactable
	{
		[Inject]
		...
		protected override void Awake()
		{
			...
			{
				EvilLogger.LogError("LiquidContainerComponent is missing on " + base.gameObject.name, "Awake", "A:\\Nomad Drive Folder\\NomadDrive\\Assets\\_Project\\Features\\LiquidTransferSystem\\Scripts\\Core\\StaticLiquidContainer.cs", 27);
			}
		}
