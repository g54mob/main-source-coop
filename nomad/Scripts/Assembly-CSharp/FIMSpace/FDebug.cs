...
namespace FIMSpace
{
	public static class FDebug
	{
		...
		public static void DrawBounds3D(this Bounds b, Color c, float scale = 1f, float time = 1.01f)
		{
			...
			Debug.DrawLine(vector, vector2, c, time);
			Debug.DrawLine(vector2, vector3, c, time);
			Debug.DrawLine(vector2, vector3, c, time);
			Debug.DrawLine(vector3, vector4, c, time);
			Debug.DrawLine(vector4, vector, c, time);
			...
			Debug.DrawLine(vector5, vector6, c, time);
			Debug.DrawLine(vector6, vector7, c, time);
			Debug.DrawLine(vector6, vector7, c, time);
			Debug.DrawLine(vector7, vector8, c, time);
			Debug.DrawLine(vector8, vector5, c, time);
			Debug.DrawLine(vector, vector, c, time);
			Debug.DrawLine(vector6, vector2, c, time);
			Debug.DrawLine(vector3, vector7, c, time);
			Debug.DrawLine(vector4, vector8, c, time);
		}
	}
}
