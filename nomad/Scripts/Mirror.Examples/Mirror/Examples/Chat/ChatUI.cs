...
namespace Mirror.Examples.Chat
{
	public class ChatUI : NetworkBehaviour
	{
		...
		private void CmdSend(string message, NetworkConnectionToClient sender = null)
		{
			...
			SendCommandInternal("System.Void Mirror.Examples.Chat.ChatUI::CmdSend(System.String,Mirror.NetworkConnectionToClient)", 927115572, writer, 0, requiresAuthority: false);
		...
		private void RpcReceive(string playerName, string message)
		{
			...
			writer.WriteString(message);
			SendRPCInternal("System.Void Mirror.Examples.Chat.ChatUI::RpcReceive(System.String,System.String)", -1368255503, writer, 0, includeOwner: true);
			NetworkWriterPool.Return(writer);
		}
