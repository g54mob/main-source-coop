...
namespace Mirror.Examples.Common.Controllers.Player
{
	...
	public class PlayerControllerRBBase : NetworkBehaviour
	{
		...
		private void ApplyMove(float fixedDeltaTime)
		{
			...
			linearVelocity.y = runtimeData.jumpSpeed;
			if (runtimeData.groundState != GroundState.Grounded)
			{
				linearVelocity.y += Physics.gravity.y * fixedDeltaTime;
			}
			rigidBody.linearVelocity = new Vector3(rigidBody.linearVelocity.x, linearVelocity.y, rigidBody.linearVelocity.z);
		}
