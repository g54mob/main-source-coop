...
namespace NWH.VehiclePhysics2.Sound
{
	...
	public class SoundManager : ManagerVehicleComponent
	{
		...
		protected override void FillComponentList()
		{
			...
			{
				engineStartStopComponent, engineRunningComponent, engineFanComponent, exhaustPopComponent, turboWhistleComponent, turboFlutterComponent, transmissionWhineComponent, gearChangeComponent, airBrakeComponent, blinkerComponent,
				hornComponent, wheelSkidComponent, wheelTireNoiseComponent, crashComponent, suspensionBumpComponent, reverseBeepComponent
			};
		}
		...
		protected override void VC_Initialize()
		{
			...
			CreateSourceGO("OtherAudioSources", new Vector3(0f, 0.2f, 0f), vehicleController.transform, ref otherSourceGO);
			if (mixer == null)
			{
		...
		public override void VC_SetDefaults()
		{
			...
			if (mixer == null)
			{
				mixer = Resources.Load<AudioMixer>("NWH Vehicle Physics 2/Defaults/Sound/VehicleAudioMixer");
				if (mixer == null)
				{
