...
namespace Rewired.Demos
{
	...
	public class PlayerMouseSpriteExample : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			mouse.Rewired_002EIPlayerMouse_002EpointerSpeed = 1f;
			mouse.wheel.yAxis.repeatRate = 5f;
			mouse.Rewired_002EIPlayerMouse_002EscreenPosition = new Vector2((float)Screen.width * 0.5f, (float)Screen.height * 0.5f);
