...
namespace Drawing
{
	...
	internal struct StreamSplitter : IJob
	{
		...
		{
			PushCommands = 1114125;
			PopCommands = 2228242;
			MetaCommands = PushCommands | PopCommands;
			DynamicCommands = 0x4C0FC0 | MetaCommands;
			StaticCommands = 0xF020 | MetaCommands;
			...
			CommandSizes[11] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.SphereData>();
			...
			CommandSizes[10] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.RingData>();
			CommandSizes[12] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.BoxData>();
			CommandSizes[13] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.PlaneData>();
			CommandSizes[14] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.BoxData>();
			CommandSizes[15] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.TriangleData>();
			CommandSizes[16] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.PersistData>();
			CommandSizes[17] = UnsafeUtility.SizeOf<CommandBuilder.Command>();
			CommandSizes[18] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.TextData>();
			CommandSizes[19] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.TextData3D>();
			CommandSizes[20] = UnsafeUtility.SizeOf<CommandBuilder.Command>() + UnsafeUtility.SizeOf<CommandBuilder.LineWidthData>();
			CommandSizes[21] = UnsafeUtility.SizeOf<CommandBuilder.Command>();
			CommandSizes[22] = UnsafeUtility.SizeOf<CommandBuilder.Command>();
		}
