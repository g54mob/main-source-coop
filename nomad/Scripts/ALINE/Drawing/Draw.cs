...
namespace Drawing
{
	public static class Draw
	{
		...
		[BurstDiscard]
		public static void WireRing(float3 center, quaternion rotation, float innerRadius, float outerRadius, float startAngle = 0f, float endAngle = (float)Math.PI * 2f)
		{
		}

		[BurstDiscard]
		public static void SolidRing(float3 center, quaternion rotation, float innerRadius, float outerRadius, float startAngle = 0f, float endAngle = (float)Math.PI * 2f)
		{
		}
