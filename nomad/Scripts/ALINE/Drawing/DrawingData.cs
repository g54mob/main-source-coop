...
namespace Drawing
{
	public class DrawingData
	{
		...
		internal struct BuilderData : IDisposable
		{
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			internal unsafe delegate bool AnyBuffersWrittenTo_00000328_0024PostfixBurstDelegate(UnsafeAppendBuffer* buffers, int numBuffers);

			internal static class AnyBuffersWrittenTo_00000328_0024BurstDirectCall
			{
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = BurstCompiler.CompileFunctionPointer<AnyBuffersWrittenTo_00000328_0024PostfixBurstDelegate>(AnyBuffersWrittenTo).Value;
					}
					P_0 = Pointer;
				}
			...
			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			internal unsafe delegate void ResetAllBuffers_00000329_0024PostfixBurstDelegate(UnsafeAppendBuffer* buffers, int numBuffers);

			internal static class ResetAllBuffers_00000329_0024BurstDirectCall
			{
				private static IntPtr Pointer;
				...
				private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
				{
					if (Pointer == (IntPtr)0)
					{
						Pointer = BurstCompiler.CompileFunctionPointer<ResetAllBuffers_00000329_0024PostfixBurstDelegate>(ResetAllBuffers).Value;
					}
					P_0 = Pointer;
				}
			...
			{
				return AnyBuffersWrittenTo_00000328_0024BurstDirectCall.Invoke(buffers, numBuffers);
			}
			...
			{
				ResetAllBuffers_00000329_0024BurstDirectCall.Invoke(buffers, numBuffers);
			}
			...
			public unsafe void Submit(DrawingData gizmos)
			{
				...
				Meta meta = this.meta;
				meta.sceneModeVersion = gizmos.adjustedSceneModeVersion;
		...
		internal struct ProcessedBuilderDataContainer
		{
			...
			public bool isEmpty
			{
				get
				{
					if (data != null)
					{
						return freeSlots.Count == data.Length;
					}
					return true;
				}
			}
		...
		private static readonly Comparison<RenderedMeshWithType> meshSorter = MeshCompareByDrawingOrder;
		...
		{
			UpdateTime();
			return new CommandBuilder(this, Hasher.NotSupplied, frameRedrawScope, default(RedrawScope), !renderInGame, isBuiltInCommandBuilder: false);
		}

		internal CommandBuilder GetBuiltInBuilder(bool renderInGame = false)
		{
			UpdateTime();
			return new CommandBuilder(this, Hasher.NotSupplied, frameRedrawScope, default(RedrawScope), !renderInGame, isBuiltInCommandBuilder: true);
		}

		public CommandBuilder GetBuilder(RedrawScope redrawScope, bool renderInGame = false)
		{
			UpdateTime();
			return new CommandBuilder(this, Hasher.NotSupplied, frameRedrawScope, redrawScope, !renderInGame, isBuiltInCommandBuilder: false);
		}
		...
		public CommandBuilder GetBuilder(Hasher hasher, RedrawScope redrawScope = default(RedrawScope), bool renderInGame = false)
		{
			...
			UpdateTime();
			return new CommandBuilder(this, hasher, frameRedrawScope, redrawScope, !renderInGame, isBuiltInCommandBuilder: false);
		}
