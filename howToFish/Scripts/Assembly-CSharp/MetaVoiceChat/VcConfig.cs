...
namespace MetaVoiceChat
{
	...
	public class VcConfig
	{
		...
		public const int SamplesPerSecond = 48000;

		public const int ClipLoopSeconds = 1;

		public const int SamplesPerClip = 48000;
		...
		[Range(0.04f, 1.2f)]
		public float jitterTimeWindow = 0.24f;
		...
		[Range(1f, 10f)]
		public float outputMinBufferSize = 2f;

		[NonSerialized]
		public int framePeriodMs;
		...
		public void Init()
		{
			...
			secondsPerFrame = (float)framePeriodMs / 1000f;
			samplesPerFrame = 48000 / framesPerSecond;
			framesPerClip = framesPerSecond;
		}
	}
}
