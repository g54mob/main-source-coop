	...
	public class GraphyManager : G_Singleton<GraphyManager>
	{
		...
		private void CheckForHotkeyPresses()
		{
			if (m_toggleModeKeyCode != Key.None)
			{
				...
				{
					if (CheckFor3KeyPress(m_toggleModeKeyCode, Key.LeftCtrl, Key.LeftAlt) || CheckFor3KeyPress(m_toggleModeKeyCode, Key.RightCtrl, Key.LeftAlt) || CheckFor3KeyPress(m_toggleModeKeyCode, Key.RightCtrl, Key.RightAlt) || CheckFor3KeyPress(m_toggleModeKeyCode, Key.LeftCtrl, Key.RightAlt))
					{
						ToggleModes();
					}
				}
				...
				{
					if (CheckFor2KeyPress(m_toggleModeKeyCode, Key.LeftCtrl) || CheckFor2KeyPress(m_toggleModeKeyCode, Key.RightCtrl))
					{
						ToggleModes();
					}
				}
				...
				{
					if (CheckFor2KeyPress(m_toggleModeKeyCode, Key.LeftAlt) || CheckFor2KeyPress(m_toggleModeKeyCode, Key.RightAlt))
					{
						ToggleModes();
					}
				}
			...
			{
				if (CheckFor3KeyPress(m_toggleActiveKeyCode, Key.LeftCtrl, Key.LeftAlt) || CheckFor3KeyPress(m_toggleActiveKeyCode, Key.RightCtrl, Key.LeftAlt) || CheckFor3KeyPress(m_toggleActiveKeyCode, Key.RightCtrl, Key.RightAlt) || CheckFor3KeyPress(m_toggleActiveKeyCode, Key.LeftCtrl, Key.RightAlt))
				{
					ToggleActive();
				}
			}
			...
			{
				if (CheckFor2KeyPress(m_toggleActiveKeyCode, Key.LeftCtrl) || CheckFor2KeyPress(m_toggleActiveKeyCode, Key.RightCtrl))
				{
					ToggleActive();
				}
			}
			...
			{
				if (CheckFor2KeyPress(m_toggleActiveKeyCode, Key.LeftAlt) || CheckFor2KeyPress(m_toggleActiveKeyCode, Key.RightAlt))
				{
					ToggleActive();
				}
			}
		...
		private bool CheckFor2KeyPress(Key key1, Key key2)
		{
			if (Keyboard.current != null)
			{
				if (!Keyboard.current[key1].wasPressedThisFrame || !Keyboard.current[key2].isPressed)
				{
					if (Keyboard.current[key2].wasPressedThisFrame)
					{
						return Keyboard.current[key1].isPressed;
					}
					return false;
				}
				return true;
		...
		private bool CheckFor3KeyPress(Key key1, Key key2, Key key3)
		{
			if (Keyboard.current != null)
			{
				if ((!Keyboard.current[key1].wasPressedThisFrame || !Keyboard.current[key2].isPressed || !Keyboard.current[key3].isPressed) && (!Keyboard.current[key2].wasPressedThisFrame || !Keyboard.current[key1].isPressed || !Keyboard.current[key3].isPressed))
				{
					if (Keyboard.current[key3].wasPressedThisFrame && Keyboard.current[key1].isPressed)
					{
