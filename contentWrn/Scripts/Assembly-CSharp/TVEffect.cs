...
public class TVEffect : VolumeComponent, IPostProcessComponent
{
	...
	public ClampedFloatParameter maskDark = new ClampedFloatParameter(0.5f, 0f, 2f);

	[Range(0f, 2f)]
	[Tooltip("Light areas adjustment.")]
	public ClampedFloatParameter maskLight = new ClampedFloatParameter(1.5f, 0f, 2f);
	...
	public BoolParameter ScaleWithActualScreenSize = new BoolParameter(value: false);
