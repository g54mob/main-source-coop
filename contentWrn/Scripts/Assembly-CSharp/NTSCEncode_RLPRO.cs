...
public class NTSCEncode_RLPRO : ScriptableRendererFeature
{
	public class NTSCEncode_RLPROPass : ScriptableRenderPass
	{
		...
		private static readonly int BsizeV = Shader.PropertyToID("Bsize");

		private static readonly int val1V = Shader.PropertyToID("val1");

		private static readonly int val2V = Shader.PropertyToID("val2");
		...
		public NTSCEncode_RLPROPass(RenderPassEvent evt)
		{
			...
			Shader shader = Shader.Find("Hidden/Shader/NTSCEncode_RLPRO");
			if (shader == null)
			{
