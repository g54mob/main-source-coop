...
public class Noise : VolumeComponent, IPostProcessComponent
{
	...
	[Space]
	[Tooltip("Granularity")]
	public BoolParameter Granularity = new BoolParameter(value: false);
	...
	[Space]
	[Tooltip("Tape Noise")]
	public BoolParameter TapeNoise = new BoolParameter(value: false);
	...
	[Space]
	[Tooltip("Line Noise")]
	public BoolParameter LineNoise = new BoolParameter(value: false);
	...
	public BoolParameter SignalNoise = new BoolParameter(value: false);
