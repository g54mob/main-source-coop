...
namespace HarmonyLib
{
	public static class FastAccess
	{
		public static InstantiationHandler<T> CreateInstantiationHandler<T>()
		{
			...
			return (InstantiationHandler<T>)Extensions.CreateDelegate(dynamicMethodDefinition.Generate(), typeof(InstantiationHandler<T>));
		}
		...
		public static GetterHandler<T, S> CreateGetterHandler<T, S>(PropertyInfo propertyInfo)
		{
			...
			iLGenerator.Emit(OpCodes.Ret);
			return (GetterHandler<T, S>)Extensions.CreateDelegate(dynamicMethodDefinition.Generate(), typeof(GetterHandler<T, S>));
		}
		...
		public static SetterHandler<T, S> CreateSetterHandler<T, S>(PropertyInfo propertyInfo)
		{
			...
			iLGenerator.Emit(OpCodes.Ret);
			return (SetterHandler<T, S>)Extensions.CreateDelegate(dynamicMethodDefinition.Generate(), typeof(SetterHandler<T, S>));
		}
