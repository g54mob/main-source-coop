...
namespace EPOOutline
{
	public static class BlitUtility
	{
		...
		private static Vector3[] normals = new Vector3[8]
		{
			new Vector3(-0.578f, -0.578f, -0.578f),
			new Vector3(0.578f, -0.578f, -0.578f),
			new Vector3(0.578f, 0.578f, -0.578f),
			new Vector3(-0.578f, 0.578f, -0.578f),
			new Vector3(-0.578f, 0.578f, 0.578f),
		...
		private static MeshSetupResult? SetupForInstancing(OutlineParameters parameters)
		{
			...
			indecies[triangleIndex++] = 2;
			indecies[triangleIndex++] = 1;
			indecies[triangleIndex++] = (ushort)num;
			indecies[triangleIndex++] = 3;
			indecies[triangleIndex++] = 2;
			indecies[triangleIndex++] = 2;
			indecies[triangleIndex++] = 3;
			indecies[triangleIndex++] = 4;
			indecies[triangleIndex++] = 2;
			indecies[triangleIndex++] = 4;
			indecies[triangleIndex++] = 5;
			indecies[triangleIndex++] = 1;
			indecies[triangleIndex++] = 2;
			indecies[triangleIndex++] = 5;
			indecies[triangleIndex++] = 1;
			indecies[triangleIndex++] = 5;
			indecies[triangleIndex++] = 6;
			indecies[triangleIndex++] = (ushort)num;
			indecies[triangleIndex++] = 7;
			indecies[triangleIndex++] = 4;
			indecies[triangleIndex++] = (ushort)num;
			indecies[triangleIndex++] = 4;
			indecies[triangleIndex++] = 3;
