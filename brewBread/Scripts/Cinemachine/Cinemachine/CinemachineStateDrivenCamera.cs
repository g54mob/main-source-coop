...
namespace Cinemachine
{
	...
	public class CinemachineStateDrivenCamera : CinemachineVirtualCameraBase
	{
		...
		private CinemachineVirtualCameraBase ChooseCurrentCamera()
		{
			...
			if (PreviousStateIsValid && mActivationTime > 0f && (instruction.m_ActivateAfter > 0f || (time - mActivationTime < mActiveInstruction.m_MinDuration && instruction.m_VirtualCamera.Priority <= mActiveInstruction.m_VirtualCamera.Priority)))
			{
