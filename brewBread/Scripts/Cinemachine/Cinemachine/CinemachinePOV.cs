...
namespace Cinemachine
{
	...
	public class CinemachinePOV : CinemachineComponentBase
	{
		...
		[Tooltip("Set this if the POV should be applied to the camera state before the body position is calculated.  This is useful for body algorithms that use the rotation as input, for example Framing Transposer.")]
		...
		public Vector2 GetRecenterTarget()
		{
			...
			if (transform != null)
			{
				...
				return new Vector2(eulerAngles.y, eulerAngles.x);
			}
			return Vector2.zero;
		}
