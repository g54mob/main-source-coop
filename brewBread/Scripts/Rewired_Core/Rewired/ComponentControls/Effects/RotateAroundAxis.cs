	...
	public class RotateAroundAxis : MonoBehaviour
	{
		...
		private void Update()
		{
			if (_speed != Speed.Stopped)
			{
				...
				base.transform.Rotate(UBTdCMgMmDUkfQSXMUxOcULfkPYFA(_rotateAroundAxis), num * Time.deltaTime, _relativeTo);
			}
		}

		private static Vector3 UBTdCMgMmDUkfQSXMUxOcULfkPYFA(RotationAxis P_0)
		{
			return P_0 switch
			{
