...
namespace Rewired.Utils
{
	...
	{
		private static byte[] KiPDPXNhNZPJxZpSiRSRSNtxgYgm;

		private static byte[] intToFloatBuffer => KiPDPXNhNZPJxZpSiRSRSNtxgYgm ?? (KiPDPXNhNZPJxZpSiRSRSNtxgYgm = new byte[4]);
