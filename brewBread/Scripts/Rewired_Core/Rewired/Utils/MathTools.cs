...
namespace Rewired.Utils
{
	...
	{
		private const float vRwflDUJAEsCeEHbKANTJgVQDNPi = 1E-10f;

		private const double CxCEqsNiqQSakdRtrALOBJeuLXDE = 1E-10;

		private const float nYyuzutgEKTtSOitWSlyemntrkBr = 0.0001f;
		...
		internal static bool oASDHnqDjINJxGdPOwEdtRXNiGll(int P_0, int P_1)
		{
			if (P_0 == 0 && P_1 == 0)
			{
				return false;
		...
		private static bool BAhshxZjlhJDiXWQCfhBfrPcdVkK(Vector2 P_0, Vector2 P_1, Vector2 P_2, Vector2 P_3, out Vector2 P_4)
		{
