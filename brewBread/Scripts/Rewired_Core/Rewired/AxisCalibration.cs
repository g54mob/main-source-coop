...
namespace Rewired
{
	...
	public sealed class AxisCalibration
	{
		...
		{
			0,
			AxisCalibrationInfo.wvqTgTEioKuGVGFGeDGqmedzOdYJ(AxisCalibrationData.Default)
		} };
		...
		private void CreateDefaultHardwareCalibration(AxisCalibrationData defaultData)
		{
			...
			{
				AxisCalibrationInfo value = AxisCalibrationInfo.wvqTgTEioKuGVGFGeDGqmedzOdYJ(defaultData);
