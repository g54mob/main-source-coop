...
namespace Rewired
{
	public sealed class ControllerTemplateActionButtonMap : ControllerTemplateActionElementMap
	{
		...
		{
			ysANvLtALhiLvQPHMrzVONBSGlf = P_2;
		}
		...
		internal override int kYHECBYfnrBTBCoSAFHALwaMjook(IControllerTemplateElementSource P_0, List<ActionElementMap> P_1, bool P_2)
		{
			...
			int num = 0;
			ActionElementMap actionElementMap = zyRLEnculmXryGTXrDAuBVPBYntD(controllerTemplateButtonSource.target, ysANvLtALhiLvQPHMrzVONBSGlf);
		...
		private ActionElementMap zyRLEnculmXryGTXrDAuBVPBYntD(IControllerElementTarget P_0, Pole P_1)
		{
