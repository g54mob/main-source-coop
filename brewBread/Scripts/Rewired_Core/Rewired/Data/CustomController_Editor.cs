...
namespace Rewired.Data
{
	...
	public sealed class CustomController_Editor
	{
		...
		private sealed class kNJUlqrYEZlBnyXISxxOzoVDqRyg : IDisposable, IEnumerable, IEnumerator, IEnumerable<ControllerElementIdentifier>, IEnumerator<ControllerElementIdentifier>
		{
			...
			public CustomController_Editor TtytLoUfsgUyhsklaKccrnoMiiek;
			...
			[DebuggerHidden]
			public kNJUlqrYEZlBnyXISxxOzoVDqRyg(int P_0)
			{
			...
			private bool MoveNext()
			{
				...
				CustomController_Editor ttytLoUfsgUyhsklaKccrnoMiiek = TtytLoUfsgUyhsklaKccrnoMiiek;
				...
				case 0:
					...
					if (ttytLoUfsgUyhsklaKccrnoMiiek._elementIdentifiers == null)
					{
						return false;
					}
				...
				if (hWZNbLCFLBBWXNZxiKeGtzgrnTsg < ttytLoUfsgUyhsklaKccrnoMiiek._elementIdentifiers.Count)
				{
					VqEePGSMyrGKIqkWibsjeHcWPSIx = ttytLoUfsgUyhsklaKccrnoMiiek._elementIdentifiers[hWZNbLCFLBBWXNZxiKeGtzgrnTsg];
					RxAoyfYzYDsYonLGXsvUgwChukLk = 1;
					return true;
				}
				return false;
			...
			{
				kNJUlqrYEZlBnyXISxxOzoVDqRyg kNJUlqrYEZlBnyXISxxOzoVDqRyg2;
				if (RxAoyfYzYDsYonLGXsvUgwChukLk == -2 && wLBvvzlDcbAEPyDfgnprolEZBsgN == Thread.CurrentThread.ManagedThreadId)
				{
					...
					kNJUlqrYEZlBnyXISxxOzoVDqRyg2 = this;
				}
				else
				{
					kNJUlqrYEZlBnyXISxxOzoVDqRyg2 = new kNJUlqrYEZlBnyXISxxOzoVDqRyg(0);
					kNJUlqrYEZlBnyXISxxOzoVDqRyg2.TtytLoUfsgUyhsklaKccrnoMiiek = TtytLoUfsgUyhsklaKccrnoMiiek;
				}
				return kNJUlqrYEZlBnyXISxxOzoVDqRyg2;
			}
		...
		public IEnumerable<ControllerElementIdentifier> ElementIdentifiers => new kNJUlqrYEZlBnyXISxxOzoVDqRyg(-2)
		{
		...
		public void AddAxis()
		{
			axes.Add((Axis)uLIkuDnGrNTyqIuMSuBYQDVMNtdW(ControllerElementType.Axis));
		}

		public void AddButton()
		{
			buttons.Add((Button)uLIkuDnGrNTyqIuMSuBYQDVMNtdW(ControllerElementType.Button));
		}
		...
		public void InsertAxis(int index)
		{
			...
			axes.Insert(index, (Axis)uLIkuDnGrNTyqIuMSuBYQDVMNtdW(ControllerElementType.Axis));
		}
		...
		public void InsertButton(int index)
		{
			...
			buttons.Insert(index, (Button)uLIkuDnGrNTyqIuMSuBYQDVMNtdW(ControllerElementType.Button));
		}
		...
		public void DuplicateElement(ControllerElementType type, int index)
		{
			...
			{
			case ControllerElementType.Axis:
				bgNeyfERHPpQgjwcfxvxcXDnLPhg(index, axes);
				break;
			case ControllerElementType.Button:
				bgNeyfERHPpQgjwcfxvxcXDnLPhg(index, buttons);
				break;
			default:
				throw new NotImplementedException();
			}
		...
		private void bgNeyfERHPpQgjwcfxvxcXDnLPhg<_0001>(int P_0, List<_0001> P_1) where _0001 : Element
		{
			...
			ControllerElementIdentifier controllerElementIdentifier = gylEVkbAliOlMbvPWSVQVDtwpfEo(val.elementIdentifierId, text);
		...
		private ControllerElementIdentifier gylEVkbAliOlMbvPWSVQVDtwpfEo(int P_0, string P_1)
		{
		...
		private Element uLIkuDnGrNTyqIuMSuBYQDVMNtdW(ControllerElementType P_0)
		{
			switch (P_0)
			{
			case ControllerElementType.Axis:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier2 = dsIdImFxmdfZtprEvJOFsIQHLyhm(P_0, text2, string.Empty, string.Empty);
			...
			case ControllerElementType.Button:
			{
				...
				ControllerElementIdentifier controllerElementIdentifier = dsIdImFxmdfZtprEvJOFsIQHLyhm(P_0, text, string.Empty, string.Empty);
		...
		private ControllerElementIdentifier dsIdImFxmdfZtprEvJOFsIQHLyhm(ControllerElementType P_0, string P_1, string P_2, string P_3)
		{
			int elementIdentifierIdCounter = _elementIdentifierIdCounter;
			_elementIdentifierIdCounter++;
