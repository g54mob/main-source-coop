...
namespace Rewired.Data
{
	...
	public sealed class ControllerMapLayoutManager_Rule_Editor : IDeepCloneable
	{
		...
		{
			return new ControllerMapLayoutManager.Rule(_tag, (_categoryIds != null) ? _categoryIds.ToArray() : new int[0], _layoutId, _controllerSetSelector.KxgloTzSnEIWSUdTJtyefCbgClOY());
		}
