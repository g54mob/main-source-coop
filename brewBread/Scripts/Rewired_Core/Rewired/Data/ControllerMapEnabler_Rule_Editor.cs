...
namespace Rewired.Data
{
	...
	public sealed class ControllerMapEnabler_Rule_Editor : IDeepCloneable
	{
		...
		{
			return new ControllerMapEnabler.Rule(_tag, _enable, (_categoryIds != null) ? _categoryIds.ToArray() : new int[0], (_layoutIds != null) ? _layoutIds.ToArray() : new int[0], _controllerSetSelector.KxgloTzSnEIWSUdTJtyefCbgClOY());
		}
