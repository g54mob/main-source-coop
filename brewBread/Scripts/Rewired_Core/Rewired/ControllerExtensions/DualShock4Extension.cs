...
namespace Rewired.ControllerExtensions
{
	...
	{
		private class zGbxhXXgFWMcqcJRuIauEwjeRofV : IControllerExtensionSource
		{
			public readonly IDriver_DualShock4 UVnyPZOPqXebrkDwGURsMwQhOdVT;

			public readonly bool BMKmLgTjByiExXMvsepaerGfBiXH;

			public readonly int IvQuNSqDypWdalUGYcleYiqEVPmd;

			public zGbxhXXgFWMcqcJRuIauEwjeRofV(IDriver_DualShock4 P_0, bool P_1, int P_2)
			{
		...
		private zGbxhXXgFWMcqcJRuIauEwjeRofV eyyVWBZaxsCJCQMmwhCWcagfYfzWA;
		...
		internal DualShock4Extension(IDriver_DualShock4 P_0)
			: base(new zGbxhXXgFWMcqcJRuIauEwjeRofV(P_0, P_0.VibrationMotorCount > 0, P_0.VibrationMotorCount))
		{
		...
		public void SetLightFlash(float onDuration, float offDuration)
		{
			...
			{
				eyyVWBZaxsCJCQMmwhCWcagfYfzWA.UVnyPZOPqXebrkDwGURsMwQhOdVT.LightFlashOnDuration = onDuration;
				eyyVWBZaxsCJCQMmwhCWcagfYfzWA.UVnyPZOPqXebrkDwGURsMwQhOdVT.LightFlashOffDuration = offDuration;
			}
		}
		...
		public void StopLightFlash()
		{
			...
			{
				eyyVWBZaxsCJCQMmwhCWcagfYfzWA.UVnyPZOPqXebrkDwGURsMwQhOdVT.StopLightFlash();
			}
		}
		...
		{
			eyyVWBZaxsCJCQMmwhCWcagfYfzWA = P_0 as zGbxhXXgFWMcqcJRuIauEwjeRofV;
