...
namespace Rewired
{
	...
	{
		private const string DquhqNUyYmEhFFwUdsMZmcTHIUBq = "[^a-fA-F0-9]";
		...
		{
			if (string.IsNullOrEmpty(TPRezqyBJaqAhrsXCtRuOMghdRbr(P_0)))
			{
				productId = 0;
				vendorId = 0;
				return;
		...
		{
			return qajYDbpNHCIIoivsnALZDiWwOuRfb(TPRezqyBJaqAhrsXCtRuOMghdRbr(pidVid));
		}
		...
		private bool qajYDbpNHCIIoivsnALZDiWwOuRfb(string P_0)
		{
		...
		private static string TPRezqyBJaqAhrsXCtRuOMghdRbr(string P_0)
		{
