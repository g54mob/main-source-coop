...
namespace Rewired
{
	public struct ElementAssignment
	{
		...
		{
			type = OzpbBOHoTkskKeBaOXWaTXQCmjjBA.MlfBuKtnYXMPsXZFSLJhadIQfWdh(P_0, P_1, P_3);
		...
		public ElementAssignment(KeyCode P_0, ModifierKeyFlags P_1, int P_2, Pole P_3)
		{
			...
			elementIdentifierId = Keyboard.qLwqAFVXIrkFTLxKuwVLiCCndNbkA(Keyboard.lbKrYDonKuonbZuyvZjwCetiVeki(P_0));
			axisRange = AxisRange.Positive;
			keyboardKey = P_0;
