...
namespace Rewired
{
	public abstract class ControllerMapSaveData
	{
		...
		internal static _0001 lOzmglNwrCkddSvkHTjSvLufiURJ<_0001>(Controller P_0, ControllerMap P_1) where _0001 : ControllerMapSaveData
		{
			return (_0001)lOzmglNwrCkddSvkHTjSvLufiURJ(P_0, P_1);
		}

		internal static ControllerMapSaveData lOzmglNwrCkddSvkHTjSvLufiURJ(Controller P_0, ControllerMap P_1)
		{
