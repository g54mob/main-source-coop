...
public abstract class EnemyAI : NetworkBehaviour
{
	...
	public void SyncAgentMaskSwimmingRpc(bool setSwimming)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			...
			FastBufferWriter bufferWriter = __beginSendRpc(1958311962u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			bufferWriter.WriteValueSafe(in setSwimming, default(FastBufferWriter.ForPrimitives));
			__endSendRpc(ref bufferWriter, 1958311962u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage == __RpcExecStage.Execute)
		{
			__rpc_exec_stage = __RpcExecStage.Send;
	...
	private void UpdateEnemyPositionRpc(Vector3 newPos)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(1277166335u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in newPos);
				__endSendRpc(ref bufferWriter, 1277166335u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	{
		__registerRpc(2081148948u, __rpc_handler_2081148948, "SwitchToBehaviourServerRpc");
		__registerRpc(2962895088u, __rpc_handler_2962895088, "SwitchToBehaviourClientRpc");
		__registerRpc(1958311962u, __rpc_handler_1958311962, "SyncAgentMaskSwimmingRpc");
		__registerRpc(1810146992u, __rpc_handler_1810146992, "KillEnemyServerRpc");
		__registerRpc(1614111717u, __rpc_handler_1614111717, "KillEnemyClientRpc");
		__registerRpc(3079913705u, __rpc_handler_3079913705, "UpdateEnemyRotationServerRpc");
		__registerRpc(1258118513u, __rpc_handler_1258118513, "UpdateEnemyRotationClientRpc");
		__registerRpc(1277166335u, __rpc_handler_1277166335, "UpdateEnemyPositionRpc");
		__registerRpc(3587030867u, __rpc_handler_3587030867, "ChangeEnemyOwnerServerRpc");
		__registerRpc(245785831u, __rpc_handler_245785831, "ChangeEnemyOwnerClientRpc");
		__registerRpc(3538577804u, __rpc_handler_3538577804, "HitEnemyServerRpc");
		__registerRpc(601871377u, __rpc_handler_601871377, "HitEnemyClientRpc");
	...
	private static void __rpc_handler_1958311962(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((EnemyAI)target).SyncAgentMaskSwimmingRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}
	...
	private static void __rpc_handler_1277166335(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((EnemyAI)target).UpdateEnemyPositionRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}
