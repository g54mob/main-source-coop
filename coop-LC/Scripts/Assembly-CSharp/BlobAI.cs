...
public class BlobAI : EnemyAI
{
	...
	{
		__registerRpc(3848306567u, __rpc_handler_3848306567, "SlimeKillPlayerEffectServerRpc");
		__registerRpc(1531516867u, __rpc_handler_1531516867, "SlimeKillPlayerEffectClientRpc");
