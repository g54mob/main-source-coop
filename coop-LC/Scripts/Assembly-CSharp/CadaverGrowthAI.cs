...
public class CadaverGrowthAI : EnemyAI
{
	...
	public void CoughSporesRpc(float loudness, int playerId)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			...
			FastBufferWriter bufferWriter = __beginSendRpc(2267295553u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			bufferWriter.WriteValueSafe(in loudness, default(FastBufferWriter.ForPrimitives));
			BytePacker.WriteValueBitPacked(bufferWriter, playerId);
			__endSendRpc(ref bufferWriter, 2267295553u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			return;
	...
	public void SyncSpawnPlantRpc(int plantId, int tileIndex, Vector3 spawnPosition, Quaternion spawnRotation, float randomSize, bool spawnScanNode, bool spawnDecal)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			...
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(1575435666u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, plantId);
			BytePacker.WriteValueBitPacked(bufferWriter, tileIndex);
			bufferWriter.WriteValueSafe(in spawnPosition);
			bufferWriter.WriteValueSafe(in spawnRotation);
			bufferWriter.WriteValueSafe(in randomSize, default(FastBufferWriter.ForPrimitives));
			bufferWriter.WriteValueSafe(in spawnScanNode, default(FastBufferWriter.ForPrimitives));
			bufferWriter.WriteValueSafe(in spawnDecal, default(FastBufferWriter.ForPrimitives));
			__endSendRpc(ref bufferWriter, 1575435666u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			return;
	...
	public void SyncRemoveEradicationFromTileRpc(int tileIndex)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(3576085961u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, tileIndex);
			__endSendRpc(ref bufferWriter, 3576085961u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage == __RpcExecStage.Execute)
		{
			__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void SyncAddGrowthTileRpc(int tileAtIndex, Vector3 doorPos)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(3436328774u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, tileAtIndex);
			bufferWriter.WriteValueSafe(in doorPos);
			__endSendRpc(ref bufferWriter, 3436328774u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage == __RpcExecStage.Execute)
		{
			__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void SyncAddInitialGrowthTileRpc(int tileAtIndex, Vector3 doorPos, bool gotRoomTile)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(2915668597u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, tileAtIndex);
			bufferWriter.WriteValueSafe(in doorPos);
			bufferWriter.WriteValueSafe(in gotRoomTile, default(FastBufferWriter.ForPrimitives));
			__endSendRpc(ref bufferWriter, 2915668597u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			return;
	...
	public void IncreaseBackFlowersRpc(int playerId, float infectionMeter)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(286787548u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, playerId);
			bufferWriter.WriteValueSafe(in infectionMeter, default(FastBufferWriter.ForPrimitives));
			__endSendRpc(ref bufferWriter, 286787548u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage == __RpcExecStage.Execute)
		{
			__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void AddToTimeSpentInPlantsRpc()
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(1175120045u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				__endSendRpc(ref bufferWriter, 1175120045u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void InfectPlayerRpc(int playerId, bool severe, bool emitSpores = false)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				...
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(983750933u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				BytePacker.WriteValueBitPacked(bufferWriter, playerId);
				bufferWriter.WriteValueSafe(in severe, default(FastBufferWriter.ForPrimitives));
				bufferWriter.WriteValueSafe(in emitSpores, default(FastBufferWriter.ForPrimitives));
				__endSendRpc(ref bufferWriter, 983750933u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void SyncBurstFromPlayerRpc(int playerId, Vector3 playerPosition, Vector3 playerRotation)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				...
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(937534871u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				BytePacker.WriteValueBitPacked(bufferWriter, playerId);
				bufferWriter.WriteValueSafe(in playerPosition);
				bufferWriter.WriteValueSafe(in playerRotation);
				__endSendRpc(ref bufferWriter, 937534871u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void SyncInfectionMeterRpc(int playerId, float infectionMeter)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			...
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(257869758u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, playerId);
			bufferWriter.WriteValueSafe(in infectionMeter, default(FastBufferWriter.ForPrimitives));
			__endSendRpc(ref bufferWriter, 257869758u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage == __RpcExecStage.Execute)
		{
			__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void HealInfectionSyncRpc(int infectionId, float healAmount, int clipIndex)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				...
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(1254841495u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				BytePacker.WriteValueBitPacked(bufferWriter, infectionId);
				bufferWriter.WriteValueSafe(in healAmount, default(FastBufferWriter.ForPrimitives));
				BytePacker.WriteValueBitPacked(bufferWriter, clipIndex);
				__endSendRpc(ref bufferWriter, 1254841495u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void CurePlayerRpc(int playerId)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(2765545537u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				BytePacker.WriteValueBitPacked(bufferWriter, playerId);
				__endSendRpc(ref bufferWriter, 2765545537u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	{
		__registerRpc(2267295553u, __rpc_handler_2267295553, "CoughSporesRpc");
		__registerRpc(1575435666u, __rpc_handler_1575435666, "SyncSpawnPlantRpc");
		__registerRpc(3576085961u, __rpc_handler_3576085961, "SyncRemoveEradicationFromTileRpc");
		__registerRpc(3436328774u, __rpc_handler_3436328774, "SyncAddGrowthTileRpc");
		__registerRpc(2915668597u, __rpc_handler_2915668597, "SyncAddInitialGrowthTileRpc");
		__registerRpc(286787548u, __rpc_handler_286787548, "IncreaseBackFlowersRpc");
		__registerRpc(1175120045u, __rpc_handler_1175120045, "AddToTimeSpentInPlantsRpc");
		__registerRpc(983750933u, __rpc_handler_983750933, "InfectPlayerRpc");
		__registerRpc(937534871u, __rpc_handler_937534871, "SyncBurstFromPlayerRpc");
		__registerRpc(257869758u, __rpc_handler_257869758, "SyncInfectionMeterRpc");
		__registerRpc(1254841495u, __rpc_handler_1254841495, "HealInfectionSyncRpc");
		__registerRpc(2765545537u, __rpc_handler_2765545537, "CurePlayerRpc");
		base.__initializeRpcs();
	}

	private static void __rpc_handler_2267295553(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			((CadaverGrowthAI)target).CoughSporesRpc(value, value2);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_1575435666(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			reader.ReadValueSafe(out Quaternion value4);
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).SyncSpawnPlantRpc(value, value2, value3, value4, value5, value6, value7);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_3576085961(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			ByteUnpacker.ReadValueBitPacked(reader, out int value);
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).SyncRemoveEradicationFromTileRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_3436328774(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).SyncAddGrowthTileRpc(value, value2);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_2915668597(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).SyncAddInitialGrowthTileRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_286787548(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).IncreaseBackFlowersRpc(value, value2);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_1175120045(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).AddToTimeSpentInPlantsRpc();
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_983750933(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			reader.ReadValueSafe(out bool value3, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).InfectPlayerRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_937534871(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			reader.ReadValueSafe(out Vector3 value3);
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).SyncBurstFromPlayerRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_257869758(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			reader.ReadValueSafe(out float value2, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).SyncInfectionMeterRpc(value, value2);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_1254841495(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).HealInfectionSyncRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_2765545537(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			ByteUnpacker.ReadValueBitPacked(reader, out int value);
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((CadaverGrowthAI)target).CurePlayerRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}
