...
public class PumaAI : EnemyAI
{
	...
	public void StartLeapToTreeRpc(Vector3 leapFrom, Vector3 leapTo, float yRot, bool leapAnim)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				...
				FastBufferWriter bufferWriter = __beginSendRpc(3099292174u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in leapFrom);
				bufferWriter.WriteValueSafe(in leapTo);
				bufferWriter.WriteValueSafe(in yRot, default(FastBufferWriter.ForPrimitives));
				bufferWriter.WriteValueSafe(in leapAnim, default(FastBufferWriter.ForPrimitives));
				__endSendRpc(ref bufferWriter, 3099292174u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
	...
	public void StartTreeDropRpc(Vector3 dropPosition, Vector3 dropFromPosition, float dropRotation, bool relocate)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(2597313703u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in dropPosition);
				bufferWriter.WriteValueSafe(in dropFromPosition);
				bufferWriter.WriteValueSafe(in dropRotation, default(FastBufferWriter.ForPrimitives));
				bufferWriter.WriteValueSafe(in relocate, default(FastBufferWriter.ForPrimitives));
				__endSendRpc(ref bufferWriter, 2597313703u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void StartTreeClimbRpc(Vector3 treeBottomPos, Vector3 treeTopPos, float clingRotation)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(3033780091u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in treeBottomPos);
				bufferWriter.WriteValueSafe(in treeTopPos);
				bufferWriter.WriteValueSafe(in clingRotation, default(FastBufferWriter.ForPrimitives));
				__endSendRpc(ref bufferWriter, 3033780091u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void PingPumaAttentionRpc(float timeToLook, Vector3 attentionPosition, bool setStartled = false)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			...
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(1028806234u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			...
			bufferWriter.WriteValueSafe(in setStartled, default(FastBufferWriter.ForPrimitives));
			__endSendRpc(ref bufferWriter, 1028806234u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage == __RpcExecStage.Execute)
		{
			__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void PumaDamagePlayerRpc(int scratchPlayer)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				...
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(1866351950u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				BytePacker.WriteValueBitPacked(bufferWriter, scratchPlayer);
				__endSendRpc(ref bufferWriter, 1866351950u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void SyncMovementVelocityRpc(float syncVelX, float syncVelZ, float animSpeed)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Execute)
			{
				...
				RpcParams rpcParams = default(RpcParams);
				FastBufferWriter bufferWriter = __beginSendRpc(2821063062u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in syncVelX, default(FastBufferWriter.ForPrimitives));
				bufferWriter.WriteValueSafe(in syncVelZ, default(FastBufferWriter.ForPrimitives));
				bufferWriter.WriteValueSafe(in animSpeed, default(FastBufferWriter.ForPrimitives));
				__endSendRpc(ref bufferWriter, 2821063062u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Execute)
			{
				__rpc_exec_stage = __RpcExecStage.Send;
	...
	public void SyncStalkingFrozenRpc(bool frozen)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			...
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(1009064702u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			bufferWriter.WriteValueSafe(in frozen, default(FastBufferWriter.ForPrimitives));
			__endSendRpc(ref bufferWriter, 1009064702u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			return;
	...
	public void SyncStalkingChargeRpc()
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(893028323u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			__endSendRpc(ref bufferWriter, 893028323u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			return;
	...
	public void SyncHidingQuicklyRpc(bool hiding)
	{
		...
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			RpcAttribute.RpcAttributeParams attributeParams = default(RpcAttribute.RpcAttributeParams);
			RpcParams rpcParams = default(RpcParams);
			FastBufferWriter bufferWriter = __beginSendRpc(517460854u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
			bufferWriter.WriteValueSafe(in hiding, default(FastBufferWriter.ForPrimitives));
			__endSendRpc(ref bufferWriter, 517460854u, rpcParams, attributeParams, SendTo.NotMe, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Execute)
		{
			return;
	...
	{
		__registerRpc(3099292174u, __rpc_handler_3099292174, "StartLeapToTreeRpc");
		__registerRpc(2597313703u, __rpc_handler_2597313703, "StartTreeDropRpc");
		__registerRpc(3033780091u, __rpc_handler_3033780091, "StartTreeClimbRpc");
		__registerRpc(1028806234u, __rpc_handler_1028806234, "PingPumaAttentionRpc");
		__registerRpc(1866351950u, __rpc_handler_1866351950, "PumaDamagePlayerRpc");
		__registerRpc(2821063062u, __rpc_handler_2821063062, "SyncMovementVelocityRpc");
		__registerRpc(1009064702u, __rpc_handler_1009064702, "SyncStalkingFrozenRpc");
		__registerRpc(893028323u, __rpc_handler_893028323, "SyncStalkingChargeRpc");
		__registerRpc(517460854u, __rpc_handler_517460854, "SyncHidingQuicklyRpc");
		base.__initializeRpcs();
	}

	private static void __rpc_handler_3099292174(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			((PumaAI)target).StartLeapToTreeRpc(value, value2, value3, value4);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_2597313703(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			reader.ReadValueSafe(out bool value4, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((PumaAI)target).StartTreeDropRpc(value, value2, value3, value4);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_3033780091(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			reader.ReadValueSafe(out float value3, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((PumaAI)target).StartTreeClimbRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_1028806234(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((PumaAI)target).PingPumaAttentionRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_1866351950(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((PumaAI)target).PumaDamagePlayerRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_2821063062(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			reader.ReadValueSafe(out float value3, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((PumaAI)target).SyncMovementVelocityRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_1009064702(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((PumaAI)target).SyncStalkingFrozenRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_893028323(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((PumaAI)target).SyncStalkingChargeRpc();
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}

	private static void __rpc_handler_517460854(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
			reader.ReadValueSafe(out bool value, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Execute;
			((PumaAI)target).SyncHidingQuicklyRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.Send;
		}
	}
