...
namespace Photon.Voice.Unity.Demos.DemoVoiceUI
{
	public class RemoteSpeakerUI : MonoBehaviour, IInRoomCallbacks
	{
		...
		protected Player Actor
		{
			get
			{
				if (realtimeClient == null || realtimeClient.CurrentRoom == null)
				{
					return null;
				}
				return realtimeClient.CurrentRoom.GetPlayer(speaker.RemoteVoice.PlayerId);
			}
		}
		...
		{
			voiceConnection = vC;
			realtimeClient = voiceConnection.Client;
