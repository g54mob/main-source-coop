...
namespace Photon.Voice.Unity.Demos.DemoVoiceUI
{
	...
	public class DemoVoiceUI : MonoBehaviour, IInRoomCallbacks, IMatchmakingCallbacks
	{
		...
		protected virtual void Update()
		{
			...
			serverStatusText.text = $"{voiceConnection.Client.CurrentRegion}/{voiceConnection.Client.CurrentServerAddress}";
			...
			rttText.text = "RTT:" + voiceConnection.Client.RealtimePeer.Stats.RoundtripTime;
			SetTextColor(voiceConnection.Client.RealtimePeer.Stats.RoundtripTime, rttText, rttYellowThreshold, rttRedThreshold);
			rttVariationText.text = "VAR:" + voiceConnection.Client.RealtimePeer.Stats.RoundtripTimeVariance;
			SetTextColor(voiceConnection.Client.RealtimePeer.Stats.RoundtripTimeVariance, rttVariationText, rttVariationYellowThreshold, rttVariationRedThreshold);
		}
		...
		protected virtual void OnActorPropertiesChanged(Player targetPlayer, PhotonHashtable changedProps)
		{
