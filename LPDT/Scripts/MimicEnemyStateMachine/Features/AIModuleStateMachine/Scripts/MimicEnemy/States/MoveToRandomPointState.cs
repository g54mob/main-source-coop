...
{
	public class MoveToRandomPointState : StateBase<MimicStateId>
	{
		private readonly MimicEnemy _enemy;

		private readonly MimicEnemyContext _context;

		public MoveToRandomPointState(MimicEnemy enemy, MimicEnemyContext context)
			: base(false, false)
		{
			_enemy = enemy;
			_context = context;
		...
		{
			_enemy.SetCurrentStateId(MimicStateId.MoveToRandomPos);
