...
{
	public class ButtonWithNavigationCallbacksWithoutMouseWithSubmit : Button, ISelectableWithNavigationCallbacks, ISelectableWithNavigationMoveCallbacks, ISubmittableWithNavigationCallbacks, IMouseSelectableWithNavigationCallbacks
	{
		[SerializeField]
