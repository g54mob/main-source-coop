...
{
	public class SelectableWithNavigationCallbacks : Selectable, ISelectableWithNavigationCallbacks, ISelectableWithNavigationMoveCallbacks
	{
		[SerializeField]
		...
		protected MoveDirection MoveDirectionFrom;
