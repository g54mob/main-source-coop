...
namespace Obi
{
	public class ComputeDistanceConstraints : ComputeConstraintsImpl<ComputeDistanceConstraintsBatch>
	{
		...
		public ComputeDistanceConstraints(ComputeSolverImpl solver)
			: base(solver, Oni.ConstraintType.Distance)
		{
			constraintsShader = Object.Instantiate(Resources.Load<ComputeShader>("Compute/DistanceConstraints"));
		...
		{
			ComputeDistanceConstraintsBatch computeDistanceConstraintsBatch = new ComputeDistanceConstraintsBatch(this);
			batches.Add(computeDistanceConstraintsBatch);
			return computeDistanceConstraintsBatch;
		}
		...
		{
			foreach (ComputeDistanceConstraintsBatch batch in batches)
			{
