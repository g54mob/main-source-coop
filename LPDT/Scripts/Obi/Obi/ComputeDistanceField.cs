...
namespace Obi
{
	public class ComputeDistanceField
	{
		...
		{
			shader = Object.Instantiate(Resources.Load<ComputeShader>("Compute/DistanceFieldShape"));
		...
		public void GenerateContacts(ComputeSolverImpl solver, ComputeColliderWorld world, float deltaTime)
		{
			...
			{
				shader.SetInt("maxContacts", 262144);
				...
				shader.DispatchIndirect(kernel, world.dispatchBuffer, 128u);
			}
		}
	}
}
