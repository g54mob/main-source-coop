...
namespace Photon.Voice.Unity.UtilityScripts
{
	public class MicrophonePermission : VoiceComponent
	{
		...
		public bool HasPermission
		{
			...
			private set
			{
				base.Logger.Log(LogLevel.Info, "Microphone Permission Granted: {0}", value);
				...
				if (component != null)
				{
					...
					{
						base.Logger.Log(LogLevel.Info, "Starting recording automatically");
					}
					component.RecordingEnabled = true;
				}
				else
				{
					base.Logger.Log(LogLevel.Info, "Recorder not found. Assign MicrophonePermission to an object with Recorder to automatically start recording");
				}
			}
		}
