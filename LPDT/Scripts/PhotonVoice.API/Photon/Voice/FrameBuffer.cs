...
namespace Photon.Voice
{
	public struct FrameBuffer
	{
		...
		public override string ToString()
		{
			...
			FrameFlags frameFlags2 = Flags & FrameFlags.MaskPart;
			return "#" + FrameNum + " " + frameFlags2.ToString() + " " + frameFlags.ToString() + ((frameFlags == FrameFlags.FragNotEnd) ? (" c#" + array[offset + count - 1]) : "") + (IsFEC ? " FEC" : "") + " r#" + refCnt;
		}
	}
}
