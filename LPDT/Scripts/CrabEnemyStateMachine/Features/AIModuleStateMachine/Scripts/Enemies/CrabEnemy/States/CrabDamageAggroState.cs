...
{
	public class CrabDamageAggroState : StateBase<CrabStateId>
	{
		private readonly CrabEnemy _enemy;

		private readonly CrabEnemyContext _context;

		public CrabDamageAggroState(CrabEnemy enemy, CrabEnemyContext context)
			: base(false, false)
		{
			_enemy = enemy;
			_context = context;
		...
		{
			_enemy.SetCurrentStateId(CrabStateId.DamageAggro);
		...
		public override void OnLogic()
		{
			...
			{
				_enemy.TriggerEvent(CrabEvent.OnDamageAggroTimeout);
			}
