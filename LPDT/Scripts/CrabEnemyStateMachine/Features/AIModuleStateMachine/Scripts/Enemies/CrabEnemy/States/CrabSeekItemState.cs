...
{
	public class CrabSeekItemState : StateBase<CrabStateId>
	{
		private readonly CrabEnemy _enemy;

		private readonly CrabEnemyContext _context;

		public CrabSeekItemState(CrabEnemy enemy, CrabEnemyContext context)
			: base(false, false)
		{
			_enemy = enemy;
			_context = context;
		...
		{
			_enemy.SetCurrentStateId(CrabStateId.SeekItem);
			...
			_context.CrabItemCarrySystem.Enable();
		...
		public override void OnExit()
		{
			...
			_context.CrabItemCarrySystem.Disable();
		...
		public override void OnLogic()
		{
			...
			{
				_enemy.TriggerEvent(CrabEvent.OnItemPickedUp);
			}
		}
	}
}
