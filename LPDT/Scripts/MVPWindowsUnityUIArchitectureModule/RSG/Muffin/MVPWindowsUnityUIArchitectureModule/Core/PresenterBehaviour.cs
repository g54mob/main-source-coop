...
namespace RSG.Muffin.MVPWindowsUnityUIArchitectureModule.Core
{
	public abstract class PresenterBehaviour
	{
		...
		public bool IsViewShown => ViewBehaviour.IsShown;
	...
	{
		protected TViewType View => base.ViewBehaviour as TViewType;
	}
}
