...
namespace RSG.Muffin.MVPWindowsUnityUIArchitectureModule.Core
{
	...
	{
		public PresenterCannotBeCreatedException(Type viewType)
			: base(GenerateMessage(viewType))
		{
		}

		public PresenterCannotBeCreatedException(Type viewType, Exception innerException)
