...
namespace RSG.Muffin.MVPWindowsUnityUIArchitectureModule.Core
{
	...
	{
		public ViewIsNotSuitableException(Type viewType)
			: base(GenerateMessage(viewType))
		{
		}

		public ViewIsNotSuitableException(Type viewType, Exception innerException)
