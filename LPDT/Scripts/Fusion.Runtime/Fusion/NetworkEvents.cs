...
namespace Fusion
{
	...
	public class NetworkEvents : Behaviour, INetworkRunnerCallbacks, IPublicFacingInterface
	{
		...
		[Serializable]
		public class ReliableDataEvent : UnityEvent<NetworkRunner, PlayerRef, ReliableKey, byte[]>
		{
		}
		...
		public ReliableProgressEvent OnReliableDataProgress;
		...
		{
			OnReliableData?.Invoke(runner, player, key, data.ToArray());
		}
