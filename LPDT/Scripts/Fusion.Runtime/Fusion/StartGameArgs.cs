...
namespace Fusion
{
	public struct StartGameArgs
	{
		...
		public override readonly string ToString()
		{
			...
			return "[StartGameArgs: " + string.Format("{0}={1}, ", "GameMode", GameMode) + "SessionName=" + SessionName + ", " + string.Format("{0}={1}, ", "IsVisible", IsVisible) + string.Format("{0}={1}, ", "IsOpen", IsOpen) + string.Format("{0}={1}, ", "Address", Address) + string.Format("{0}={1}, ", "CustomPublicAddress", CustomPublicAddress) + string.Format("{0}={1}, ", "ObjectProvider", ObjectProvider) + string.Format("{0}={1}, ", "SceneManager", SceneManager) + string.Format("{0}={1}, ", "PlayerCount", PlayerCount) + string.Format("{0}={1}, ", "Scene", Scene) + string.Format("{0}={1}, ", "DisableNATPunchthrough", DisableNATPunchthrough) + "CustomCallbackInterfaces=" + text + ", ConnectionToken=" + text2 + ", SessionProperties=" + text3 + ", CustomLobbyName=" + CustomLobbyName + ", CustomSTUNServer=" + CustomSTUNServer + ", " + string.Format("{0}={1}, ", "AuthValues", AuthValues) + string.Format("{0}={1}, ", "CustomPhotonAppSettings", CustomPhotonAppSettings) + string.Format("{0}={1}, ", "EnableClientSessionCreation", EnableClientSessionCreation) + string.Format("{0}={1}, ", "HostMigrationToken", HostMigrationToken) + string.Format("{0}={1}, ", "StartGameCancellationToken", StartGameCancellationToken) + string.Format("{0}={1}, ", "UseCachedRegions", UseCachedRegions) + string.Format("{0}={1}]", "MatchmakingMode", MatchmakingMode);
		}
	}
}
