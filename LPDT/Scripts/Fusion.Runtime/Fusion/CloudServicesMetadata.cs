...
namespace Fusion
{
	internal class CloudServicesMetadata
	{
		...
		public RejoinMetadata RejoinMetadata = new RejoinMetadata();
		...
		public ProtocolMessageVersion CurrentProtocolMessageVersion { get; set; } = ProtocolMessageVersion.V1_7_0;
