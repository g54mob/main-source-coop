...
namespace Fusion
{
	public readonly struct NetworkSpawnOp
	{
		internal class AsyncOpData
		{
			...
			{
				Assert.Check(Status == NetworkSpawnStatus.Queued, "Status == NetworkSpawnStatus.Queued");
				Assert.Check(op.Status != NetworkSpawnStatus.Queued, "op.Status != NetworkSpawnStatus.Queued");
				Status = op.Status;
				Object = op.Object;
		...
		public struct Awaiter : INotifyCompletion
		{
			...
			public readonly bool IsCompleted => _op.Status != NetworkSpawnStatus.Queued;
