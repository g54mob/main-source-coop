...
{
	[Serializable]
	public class NetworkConfiguration : IConfigurationSanityCheck
	{
		[Flags]
		...
		{
			ConnectionShutdownTime = Math.Max(1.0, ConnectionShutdownTime);
			ConnectionTimeout = Math.Clamp(ConnectionTimeout, 1.0, 300.0);
		}
	}
}
