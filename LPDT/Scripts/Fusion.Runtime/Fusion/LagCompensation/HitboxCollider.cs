...
namespace Fusion.LagCompensation
{
	internal struct HitboxCollider
	{
		...
		internal readonly Vector3 CapsuleLocalTopCenter => Offset + Vector3.up * (Mathf.Max(CapsuleExtents * 0.5f, Radius) - Radius);

		internal readonly Vector3 CapsuleLocalBottomCenter => Offset + Vector3.down * (Mathf.Max(CapsuleExtents * 0.5f, Radius) - Radius);
