...
{
	[Serializable]
	public class HeapConfiguration : IConfigurationSanityCheck
	{
		internal const int PageCountMin = 16;

		internal const int PageCountMax = 4096;
		...
		{
			PageCount = Math.Clamp(PageCount, 16, 4096);
		}
	}
}
