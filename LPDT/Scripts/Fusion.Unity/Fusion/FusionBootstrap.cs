...
namespace Fusion
{
	...
	public class FusionBootstrap : Behaviour
	{
		...
		protected virtual void Start()
		{
			...
			NetworkRunner networkRunner = UnityEngine.Object.FindAnyObjectByType<NetworkRunner>();
		...
		private void Update()
		{
			...
			{
				PhysicsScene physicsScene = instance.GetPhysicsScene();
				if (physicsScene.IsValid() && Physics.simulationMode != SimulationMode.Script && physicsScene != Physics.defaultPhysicsScene)
				{
