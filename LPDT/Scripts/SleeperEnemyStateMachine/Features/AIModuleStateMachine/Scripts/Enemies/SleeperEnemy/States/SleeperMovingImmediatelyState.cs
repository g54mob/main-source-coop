...
{
	public class SleeperMovingImmediatelyState : StateBase<SleeperStateId>
	{
		...
		public SleeperMovingImmediatelyState(SleeperEnemy enemy, SleeperEnemyContext context, SleeperEnemySettings settings)
			: base(false, false)
		{
			_enemy = enemy;
			_context = context;
		...
		{
			_enemy.SetCurrentStateId(SleeperStateId.MovingImmediately);
			_context.SetVisualState(SleeperVisualState.MovingImmediately);
