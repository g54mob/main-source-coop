...
namespace Features.AIModuleStateMachine.Scripts.Pirato
{
	...
	public class EnemyPistolWeapon : EnemyWeaponBase
	{
		...
		[Rpc(RpcSources.All, RpcTargets.All, Key = 2666031392u)]
		private void PlayParticleRpc()
		{
			if (!NetworkBehaviourUtils.CheckInvokeRpc((NetworkBehaviour)this))
			{
				RpcInvokeInfo invokeInfo;
				using (Fusion.RpcBuilder rpcBuilder = base.Runner.CreateRpcBuilder(2666031392u, 0, (NetworkBehaviour)this, PlayerRef.Invalid))
				{
					invokeInfo = rpcBuilder.Prepare(out var _);
					if (NetworkBehaviourUtils.ShouldNotifyRpcError(invokeInfo))
					{
						NetworkBehaviourUtils.NotifyRpcError((ILogSource)this, "System.Void Features.AIModuleStateMachine.Scripts.Pirato.EnemyPistolWeapon::PlayParticleRpc()", invokeInfo, PlayerRef.None);
					}
		...
		[NetworkRpcWeavedInvoker(2666031392u)]
		[Preserve]
		[WeaverGenerated]
		protected static void PlayParticleRpc_0040Invoker2666031392([In] ref RpcInvokeContext context)
		{
