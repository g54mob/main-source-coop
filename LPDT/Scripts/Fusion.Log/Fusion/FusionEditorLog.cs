...
namespace Fusion
{
	public abstract class FusionEditorLog
	{
		...
		[Conditional("FUSION_EDITOR_TRACE")]
		public static void TracePlugin(string msg)
		{
			UnityEngine.Debug.Log("<color" + s_prefixColor + ">[FusionEditor/Plugin]</color> " + msg);
		}

		[Conditional("UNITY_EDITOR")]
		public static void WarnPlugin(string msg)
		{
			UnityEngine.Debug.LogWarning("<color" + s_prefixColor + ">[FusionEditor/Plugin]</color> " + msg);
		}

		[Conditional("UNITY_EDITOR")]
		public static void LogPlugin(string msg)
		{
			UnityEngine.Debug.Log("<color" + s_prefixColor + ">[FusionEditor/Plugin]</color> " + msg);
		}

		[Conditional("UNITY_EDITOR")]
		public static void ErrorPlugin(string msg)
		{
			UnityEngine.Debug.LogError("<color" + s_prefixColor + ">[FusionEditor/Plugin]</color> " + msg);
		}
		...
		{
			UnityEngine.Debug.LogWarning($"<color{s_prefixColor}>[FusionEditor]</color>: {ex.GetType()} <i>See next error log entry for details.</i>", obj);
			ExceptionDispatchInfo edi = ExceptionDispatchInfo.Capture(ex);
			Thread thread = new Thread((ThreadStart)delegate
			{
				edi.Throw();
		...
		[Conditional("UNITY_EDITOR")]
		[HideInCallstack]
		public static void Exception(string message, Exception ex, UnityEngine.Object obj)
		{
			UnityEngine.Debug.LogWarning("<color" + s_prefixColor + ">[FusionEditor]</color>: " + message + " <i>See next error log entry for details.</i>", obj);
			ExceptionDispatchInfo edi = ExceptionDispatchInfo.Capture(ex);
			Thread thread = new Thread((ThreadStart)delegate
			{
				edi.Throw();
