...
namespace Fusion
{
	public static class InternalLogStreams
	{
		...
		[CanBeNull]
		internal static TraceLogStream LogTraceAreaOfInterest;
		...
		[CanBeNull]
		internal static TraceLogStream LogTraceSendRecv;

		[CanBeNull]
		internal static TraceLogStream LogTracePools;

		[CanBeNull]
		internal static TraceLogStream LogTraceParent;

		[CanBeNull]
		internal static TraceLogStream LogTraceForecast;

		[CanBeNull]
		internal static TraceLogStream LogTraceAutomatedRun;

		[CanBeNull]
		internal static TraceLogStream LogTracePluginVersion;
	}
}
