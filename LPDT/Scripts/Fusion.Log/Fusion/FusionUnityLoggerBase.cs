...
namespace Fusion
{
	public abstract class FusionUnityLoggerBase : IDisposable
	{
		...
		public static Color32 DefaultLightPrefixColor => new Color32(20, 64, 120, byte.MaxValue);

		public static Color32 DefaultDarkPrefixColor => new Color32(115, 172, 229, byte.MaxValue);
		...
		private static int GetRandomColor(int seed, Color32 min, Color32 max)
		{
			...
			uint num5 = (uint)((int)(num % num2) + min.r);
			ulong num6 = num / num2;
			uint num7 = (uint)((int)(num6 % num3) + min.g);
			uint num8 = (uint)((int)(num6 / num3 % num4) + min.b);
			...
			static ulong NextSplitMix(ref ulong reference)
			{
				...
				long num11 = (long)((ulong)num10 ^ ((ulong)num10 >> 27)) * -7723592293110705685L;
				return (ulong)num11 ^ ((ulong)num11 >> 31);
			}
		}
