namespace Fusion.Sockets
{
	...
	{
		internal const int MaxConnectionsLimit = 2048;
		...
		public readonly int ConnectionsPerGroup
		{
			get
			{
		...
		public readonly int PacketSizeInBits => PacketSize * 8;

		public readonly NetConfigSimulation Simulation => default(NetConfigSimulation);
