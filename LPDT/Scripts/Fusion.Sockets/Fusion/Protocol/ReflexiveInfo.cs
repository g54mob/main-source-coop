...
namespace Fusion.Protocol
{
	internal class ReflexiveInfo : Message
	{
		...
		public ReflexiveInfo(int actorNr, NetAddress publicAddr, NetAddress privateAddr, NATType stunNatType, byte[] uniqueID = null, ProtocolMessageVersion protocolVersion = ProtocolMessageVersion.V1_7_0, Version serializationVersion = null)
