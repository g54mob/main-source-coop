...
namespace Fusion.Protocol
{
	internal class Snapshot : Message
	{
		...
		public Snapshot(int tick, uint networkID, SnapshotType snapshotType, int snapshotSize, byte[] data, ProtocolMessageVersion protocolVersion = ProtocolMessageVersion.V1_7_0, Version serializationVersion = null)
