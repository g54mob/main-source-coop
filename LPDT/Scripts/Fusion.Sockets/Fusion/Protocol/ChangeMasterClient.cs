...
namespace Fusion.Protocol
{
	internal class ChangeMasterClient : Message
	{
		...
		public ChangeMasterClient(int newMasterClientCandidate, ProtocolMessageVersion protocolVersion = ProtocolMessageVersion.V1_7_0, Version serializationVersion = null)
