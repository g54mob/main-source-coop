...
namespace Fusion.Protocol
{
	internal class Start : Message
	{
		...
		public Start(int remoteServerId, StartRequests startRequests, ProtocolMessageVersion protocolVersion = ProtocolMessageVersion.V1_7_0, Version serializationVersion = null)
