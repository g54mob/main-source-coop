...
namespace Fusion.Protocol
{
	internal abstract class Message : IMessage
	{
		...
		public Message(ProtocolMessageVersion protocolMessage = ProtocolMessageVersion.V1_7_0, Version serializationVersion = null)
		{
		...
		public void Serialize(BitStream stream)
		{
			...
			if (FusionSerializationVersion.Major == Versioning.GetCurrentVersion.Major)
			{
		...
		public bool CheckCompatibility(ProtocolMessageVersion pluginProtocolVersion, Version pluginVersion, Version sessionSerializationVersion)
		{
			...
			if (FusionSerializationVersion == Versioning.InvalidVersion || sessionSerializationVersion == Versioning.InvalidVersion || FusionSerializationVersion.ShortVersion() > pluginVersion.ShortVersion() || FusionSerializationVersion.ShortVersion() < new Version(1, 0) || FusionSerializationVersion.ShortVersion() < new Version(2, 1))
			{
				return false;
			}
