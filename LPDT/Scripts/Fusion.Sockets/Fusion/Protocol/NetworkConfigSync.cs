...
namespace Fusion.Protocol
{
	internal class NetworkConfigSync : Message
	{
		...
		public NetworkConfigSync(SyncType type, string serializedNetworkConfig, ProtocolMessageVersion protocolVersion = ProtocolMessageVersion.V1_7_0, Version serializationVersion = null)
