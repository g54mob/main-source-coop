...
using Features.UserReport.CustomUserReporting.Scripts.Plugin.Version2018_3.Screenshots;
using UnityEngine;
...
namespace Features.UserReport.CustomUserReporting.Scripts.Plugin.Version2018_3
{
	public class AsyncUnityUserReportingPlatform : IUserReportingPlatform
	{
		...
		public virtual void ModifyUserReport(Features.UserReport.CustomUserReporting.Scripts.Client.UserReport userReport)
		{
