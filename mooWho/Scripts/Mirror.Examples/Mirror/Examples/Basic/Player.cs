...
namespace Mirror.Examples.Basic
{
	...
	public class Player : NetworkBehaviour
	{
		...
		public Action<byte, byte> _Mirror_SyncVarHookDelegate_playerNumber;

		public Action<Color32, Color32> _Mirror_SyncVarHookDelegate_playerColor;

		public Action<ushort, ushort> _Mirror_SyncVarHookDelegate_playerData;
		...
		public Color32 NetworkplayerColor
		{
			...
			set
			{
				GeneratedSyncVarSetter(value, ref playerColor, 2uL, _Mirror_SyncVarHookDelegate_playerColor);
			}
		}
		...
		public ushort NetworkplayerData
		{
			...
			set
			{
				GeneratedSyncVarSetter(value, ref playerData, 4uL, _Mirror_SyncVarHookDelegate_playerData);
			}
		}
		...
		public Player()
		{
			_Mirror_SyncVarHookDelegate_playerNumber = PlayerNumberChanged;
			_Mirror_SyncVarHookDelegate_playerColor = PlayerColorChanged;
			_Mirror_SyncVarHookDelegate_playerData = PlayerDataChanged;
		}
		...
		public override void DeserializeSyncVars(NetworkReader reader, bool initialState)
		{
			...
			if (initialState)
			{
				GeneratedSyncVarDeserialize(ref playerNumber, _Mirror_SyncVarHookDelegate_playerNumber, NetworkReaderExtensions.ReadByte(reader));
				GeneratedSyncVarDeserialize(ref playerColor, _Mirror_SyncVarHookDelegate_playerColor, reader.ReadColor32());
				GeneratedSyncVarDeserialize(ref playerData, _Mirror_SyncVarHookDelegate_playerData, reader.ReadUShort());
				return;
			}
