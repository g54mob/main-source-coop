...
namespace Mirror
{
	...
	public static class GeneratedNetworkCode
	{
		...
		public static void _Write_PlayerInfoData(NetworkWriter writer, PlayerInfoData value)
		{
			writer.WriteString(value.username);
			writer.WriteVarULong(value.steamId);
		}

		public static PlayerInfoData _Read_PlayerInfoData(NetworkReader reader)
		{
			return new PlayerInfoData
			{
				username = reader.ReadString(),
				steamId = reader.ReadVarULong()
			};
		}

		public static void _Write_BarnIntroController_002FDoorState(NetworkWriter writer, BarnIntroController.DoorState value)
		{
			writer.WriteVarInt((int)value);
		}

		public static BarnIntroController.DoorState _Read_BarnIntroController_002FDoorState(NetworkReader reader)
		{
			return (BarnIntroController.DoorState)reader.ReadVarInt();
		}

		public static void _Write_AnimalSoundLevel(NetworkWriter writer, AnimalSoundLevel value)
		{
			writer.WriteVarInt((int)value);
		}

		public static void _Write_NpcPopulationLevel(NetworkWriter writer, NpcPopulationLevel value)
		{
			writer.WriteVarInt((int)value);
		}

		public static void _Write_MapType(NetworkWriter writer, MapType value)
		{
			writer.WriteVarInt((int)value);
		}

		public static AnimalSoundLevel _Read_AnimalSoundLevel(NetworkReader reader)
		{
			return (AnimalSoundLevel)reader.ReadVarInt();
		}

		public static NpcPopulationLevel _Read_NpcPopulationLevel(NetworkReader reader)
		{
			return (NpcPopulationLevel)reader.ReadVarInt();
		}

		public static MapType _Read_MapType(NetworkReader reader)
		{
			return (MapType)reader.ReadVarInt();
		}

		public static void _Write_RaceTeam(NetworkWriter writer, RaceTeam value)
		{
			writer.WriteVarInt((int)value);
		}

		public static RaceTeam _Read_RaceTeam(NetworkReader reader)
		{
			return (RaceTeam)reader.ReadVarInt();
		}

		public static void _Write_AnimalType(NetworkWriter writer, AnimalType value)
		{
			writer.WriteVarInt((int)value);
		}

		public static AnimalType _Read_AnimalType(NetworkReader reader)
		{
			return (AnimalType)reader.ReadVarInt();
		}

		public static void _Write_PlayerRole(NetworkWriter writer, PlayerRole value)
		{
			writer.WriteVarInt((int)value);
		}

		public static PlayerRole _Read_PlayerRole(NetworkReader reader)
		{
			return (PlayerRole)reader.ReadVarInt();
		}
		...
		public static void InitReadWriters()
		{
			...
			Writer<PlayerInfoData>.write = _Write_PlayerInfoData;
			Writer<BarnIntroController.DoorState>.write = _Write_BarnIntroController_002FDoorState;
			Writer<AnimalSoundLevel>.write = _Write_AnimalSoundLevel;
			Writer<NpcPopulationLevel>.write = _Write_NpcPopulationLevel;
			Writer<MapType>.write = _Write_MapType;
			Writer<RaceTeam>.write = _Write_RaceTeam;
			Writer<AnimalType>.write = _Write_AnimalType;
			Writer<PlayerRole>.write = _Write_PlayerRole;
			...
			Reader<PlayerInfoData>.read = _Read_PlayerInfoData;
			Reader<BarnIntroController.DoorState>.read = _Read_BarnIntroController_002FDoorState;
			Reader<AnimalSoundLevel>.read = _Read_AnimalSoundLevel;
			Reader<NpcPopulationLevel>.read = _Read_NpcPopulationLevel;
			Reader<MapType>.read = _Read_MapType;
			Reader<RaceTeam>.read = _Read_RaceTeam;
			Reader<AnimalType>.read = _Read_AnimalType;
			Reader<PlayerRole>.read = _Read_PlayerRole;
		}
	}
}
