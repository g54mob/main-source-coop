...
namespace Dissonance
{
	...
	public sealed class DissonanceComms : MonoBehaviour, IPriorityManager, IAccessTokenCollection, IChannelPriorityProvider, IVolumeProvider
	{
		...
		public static readonly SemanticVersion Version = new SemanticVersion(9, 0, 9);
		...
		public static DissonanceComms GetSingleton()
		{
			...
			{
				_singleton = null;
				_singleton = UnityEngine.Object.FindAnyObjectByType<DissonanceComms>(FindObjectsInactive.Include);
			}
			return _singleton;
		}
