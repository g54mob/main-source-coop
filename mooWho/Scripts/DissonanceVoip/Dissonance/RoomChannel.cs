...
{
	public readonly struct RoomChannel : IChannel<RoomName>, IDisposable, IEquatable<RoomChannel>
	{
		private static readonly Log Log = Logs.Create(LogCategory.Core, "RoomChannel");
		...
		[NotNull]
		public string TargetId => _roomId.Name;
