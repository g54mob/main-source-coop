	...
	public class BasicMicrophoneCapture : MonoBehaviour, IMicrophoneCapture, IMicrophoneDeviceList
	{
		...
		public virtual WaveFormat StartCapture(string inputMicName)
		{
			...
			try
			{
				...
				int num2 = num * 4;
				if (_rawMicSamples == null || _rawMicSamples.WaveFormat != _format || _rawMicSamples.Capacity != num2 || _rawMicFrames == null || _rawMicFrames.FrameSize != num)
				{
					_rawMicSamples = new BufferedSampleProvider(_format, num2);
