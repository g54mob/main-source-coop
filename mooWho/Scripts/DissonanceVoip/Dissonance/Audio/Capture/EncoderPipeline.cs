...
namespace Dissonance.Audio.Capture
{
	...
	{
		private static readonly Log Log = Logs.Create(LogCategory.Recording, "EncoderPipeline");
		...
		public EncoderPipeline([NotNull] WaveFormat inputFormat, [NotNull] IVoiceEncoder encoder, [NotNull] ICommsNetwork net)
		{
			...
			_net = net ?? throw new ArgumentNullException("net");
			_inputFormat = inputFormat ?? throw new ArgumentNullException("inputFormat");
