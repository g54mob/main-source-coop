...
namespace Dissonance.Audio.Capture
{
	...
	{
		private static readonly Log Log = Logs.Create(LogCategory.Recording, "CapturePipelineManager");
		...
		public float Amplitude => _preprocessor?.Amplitude ?? 0f;
		...
		public CapturePipelineManager([NotNull] CodecSettingsLoader codecSettingsLoader, [NotNull] RoomChannels roomChannels, [NotNull] PlayerChannels playerChannels, [NotNull] ReadOnlyCollection<VoicePlayerState> players, int startupDelay = 0)
		{
			...
			_codecSettingsLoader = codecSettingsLoader ?? throw new ArgumentNullException("codecSettingsLoader");
		...
		{
			_microphone = microphone ?? throw new ArgumentNullException("microphone");
