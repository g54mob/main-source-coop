...
namespace Dissonance.Audio.Playback
{
	...
	{
		private static readonly Log Log = Logs.Create(LogCategory.Playback, "SpeechSession");
		...
		public TimeSpan Delay => TimeSpan.FromSeconds(Mathf.Clamp(Mathf.LerpUnclamped(0.1f, _jitter.Jitter * 2.5f, _jitter.Confidence), _minimumDelay, 0.75f));
