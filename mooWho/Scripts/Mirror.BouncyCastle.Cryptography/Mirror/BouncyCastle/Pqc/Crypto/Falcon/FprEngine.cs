...
namespace Mirror.BouncyCastle.Pqc.Crypto.Falcon
{
	internal class FprEngine
	{
		...
		{
			long num = (long)(x.v - 1.0);
			long num2 = (long)x.v;
			long num3 = (long)(x.v + 4503599627370496.0) - 4503599627370496L;
			long num4 = (long)(x.v - 4503599627370496.0) + 4503599627370496L;
			long num5 = num >> 63;
			num4 &= num5;
			num3 &= ~num5;
			num5 = 0L - (long)((uint)((((int)((ulong)num2 >> 52) + 1) & 0xFFF) - 2) >> 31);
			num3 &= num5;
			num4 &= num5;
			num2 &= ~num5;
