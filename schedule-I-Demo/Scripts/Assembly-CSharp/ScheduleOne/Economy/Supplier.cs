	...
	public class Supplier : NPC
	{
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EEconomy_002ESupplier(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			...
			case 2u:
			{
				...
				{
					this.sync___set_value_deadDropPreparing(syncVar___deadDropPreparing.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 1u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value_debt(syncVar___debt.GetValue(calledByUser: true), true);
					return true;
				}
