	...
	public class Dealer : NPC, IItemSlotOwner
	{
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EEconomy_002EDealer(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			...
			case 2u:
			{
				...
				{
					this.sync___set_value_acceptedContractGUIDs(syncVar___acceptedContractGUIDs.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 1u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CCash_003Ek__BackingField(syncVar____003CCash_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
