	...
	public class Constructable_GridBased : Constructable
	{
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EConstructableScripts_002EConstructable_GridBased(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			...
			case 2u:
			{
				...
				{
					this.sync___set_value_Rotation(syncVar___Rotation.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 1u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value_OriginCoordinate(syncVar___OriginCoordinate.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 0u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value_OwnerGridGUID(syncVar___OwnerGridGUID.GetValue(calledByUser: true), true);
					return true;
				}
