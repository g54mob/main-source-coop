...
namespace ScheduleOne.ObjectScripts
{
	public class Pot : GridItem, IUsable, IConfigurable, ITransitEntity
	{
		...
		public float SoilLevel
		{
			...
			protected set
			{
				this.sync___set_value__003CSoilLevel_003Ek__BackingField(value, true);
			}
		}
		...
		public string SoilID
		{
			...
			protected set
			{
				this.sync___set_value__003CSoilID_003Ek__BackingField(value, true);
			}
		}
		...
		public int RemainingSoilUses
		{
			...
			protected set
			{
				this.sync___set_value__003CRemainingSoilUses_003Ek__BackingField(value, true);
			}
		}
		...
		public float WaterLevel
		{
			...
			protected set
			{
				this.sync___set_value__003CWaterLevel_003Ek__BackingField(value, true);
			}
		}
		...
		{
			SoilID = string.Empty;
			AppliedAdditives = new List<Additive>();
			InputSlots = new List<ItemSlot>();
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EObjectScripts_002EPot(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			...
			case 5u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CPlayerUserObject_003Ek__BackingField(syncVar____003CPlayerUserObject_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 4u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CNPCUserObject_003Ek__BackingField(syncVar____003CNPCUserObject_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 3u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CWaterLevel_003Ek__BackingField(syncVar____003CWaterLevel_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 2u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CRemainingSoilUses_003Ek__BackingField(syncVar____003CRemainingSoilUses_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 1u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CSoilID_003Ek__BackingField(syncVar____003CSoilID_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 0u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CSoilLevel_003Ek__BackingField(syncVar____003CSoilLevel_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
