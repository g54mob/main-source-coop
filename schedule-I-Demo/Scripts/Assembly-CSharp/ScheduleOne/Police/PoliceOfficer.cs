...
namespace ScheduleOne.Police
{
	public class PoliceOfficer : NPC
	{
		...
		public NetworkObject TargetPlayerNOB
		{
			...
			protected set
			{
				this.sync___set_value__003CTargetPlayerNOB_003Ek__BackingField(value, true);
			}
		}
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EPolice_002EPoliceOfficer(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			if (UInt321 == 1)
			{
				...
				{
					this.sync___set_value__003CTargetPlayerNOB_003Ek__BackingField(syncVar____003CTargetPlayerNOB_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
