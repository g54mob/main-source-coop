	...
	public class RoadCheckpoint : NetworkBehaviour
	{
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EPolice_002ERoadCheckpoint(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			...
			case 1u:
			{
				...
				{
					this.sync___set_value__003CGate2Open_003Ek__BackingField(syncVar____003CGate2Open_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 0u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CGate1Open_003Ek__BackingField(syncVar____003CGate1Open_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
