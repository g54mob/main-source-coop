...
namespace ScheduleOne.PlayerScripts
{
	public class PlayerCrimeData : NetworkBehaviour
	{
		...
		public PlayerCrimeData()
		{
			...
			timeSinceLastShot = 1000f;
			Collisions = new List<VehicleCollisionInstance>();
			outOfSightTimeToDipMusic = 8f;
			minMusicVolume = 0.6f;
			musicChangeRate_Down = 0.04f;
			musicChangeRate_Up = 2f;
			base._002Ector();
		}
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EPlayerScripts_002EPlayerCrimeData(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			...
			case 1u:
			{
				...
				{
					this.sync___set_value__003CLastKnownPosition_003Ek__BackingField(syncVar____003CLastKnownPosition_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 0u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CCurrentPursuitLevel_003Ek__BackingField(syncVar____003CCurrentPursuitLevel_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
				EPursuitLevel value = GeneratedReaders___Internal.Read___ScheduleOne_002EPlayerScripts_002EPlayerCrimeData_002FEPursuitLevelFishNet_002ESerializing_002EGenerateds(PooledReader0);
