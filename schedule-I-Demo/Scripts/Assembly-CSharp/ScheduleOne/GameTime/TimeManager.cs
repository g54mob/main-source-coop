...
namespace ScheduleOne.GameTime
{
	public class TimeManager : NetworkSingleton<TimeManager>, IBaseSaveable, ISaveable
	{
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EGameTime_002ETimeManager(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			if (UInt321 == 0)
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value_hostDailySummaryDone(syncVar___hostDailySummaryDone.GetValue(calledByUser: true), true);
					return true;
				}
				bool value = PooledReader0.ReadBoolean();
				this.sync___set_value_hostDailySummaryDone(value, Boolean2);
				return true;
			}
			return false;
		}
