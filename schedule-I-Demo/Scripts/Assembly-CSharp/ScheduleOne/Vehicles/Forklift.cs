...
namespace ScheduleOne.Vehicles
{
	public class Forklift : LandVehicle
	{
		...
		{
			this.sync___set_value__003CtargetForkHeight_003Ek__BackingField(value, true);
		}
		...
		{
			this.sync___set_value__003CactualForkHeight_003Ek__BackingField(value, true);
		}
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EVehicles_002EForklift(PooledReader PooledReader0, uint UInt321, bool Boolean2)
		{
			...
			case 4u:
			{
				...
				{
					this.sync___set_value__003CactualForkHeight_003Ek__BackingField(syncVar____003CactualForkHeight_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
			...
			case 3u:
			{
				if (PooledReader0 == null)
				{
					this.sync___set_value__003CtargetForkHeight_003Ek__BackingField(syncVar____003CtargetForkHeight_003Ek__BackingField.GetValue(calledByUser: true), true);
					return true;
				}
				float value = PooledReader0.ReadSingle();
