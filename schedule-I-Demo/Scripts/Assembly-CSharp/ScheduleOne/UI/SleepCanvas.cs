	...
	public class SleepCanvas : Singleton<SleepCanvas>
	{
		...
		private void SleepStart()
		{
			...
			IEnumerator Sleep()
			{
				...
				NetworkSingleton<TimeManager>.Instance.sync___set_value_hostDailySummaryDone(false, true);
				...
				{
					NetworkSingleton<TimeManager>.Instance.sync___set_value_hostDailySummaryDone(true, true);
				}
				else
				{
