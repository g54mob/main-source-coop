...
namespace FishNet.Component.Observing
{
	public class HashGrid : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			{
				NetworkManager.StaticLogError("NetworkManager not found on object or within parent of " + base.gameObject.name + ". The " + GetType().Name + " must be placed on or beneath a NetworkManager.");
			}
